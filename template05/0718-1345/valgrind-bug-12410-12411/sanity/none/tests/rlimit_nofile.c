...
{ 
  ...
  newrlim.rlim_cur = oldrlim.rlim_max + 1UL;
  newrlim.rlim_max = oldrlim.rlim_max;
  tmp___1 = setrlimit(7, (struct rlimit  const  *)(& newrlim));
  if (tmp___1 == -1) {
    tmp___0 = __errno_location();
    if (*tmp___0 != 22) {
      fprintf((FILE */* __restrict  */)stderr,
              (char const   */* __restrict  */)"setrlimit exceeding hardlimit must set errno=EINVAL\n");
      exit(1);
    } else {
    ...
    fprintf((FILE */* __restrict  */)stderr,
            (char const   */* __restrict  */)"setrlimit exceeding hardlimit must return -1\n");
    exit(1);
  }
  newrlim.rlim_cur = oldrlim.rlim_max;
  newrlim.rlim_max = oldrlim.rlim_max + 1UL;
  tmp___3 = setrlimit(7, (struct rlimit  const  *)(& newrlim));
  if (tmp___3 == -1) {
    tmp___2 = __errno_location();
    if (*tmp___2 != 1) {
      fprintf((FILE */* __restrict  */)stderr,
              (char const   */* __restrict  */)"setrlimit changing hardlimit must set errno=EPERM\n");
      exit(1);
    } else {
    ...
    fprintf((FILE */* __restrict  */)stderr,
            (char const   */* __restrict  */)"setrlimit changing hardlimit must return -1\n");
    exit(1);
  }
  newrlim.rlim_cur = oldrlim.rlim_cur / 2UL;
  newrlim.rlim_max = oldrlim.rlim_max;
  tmp___4 = setrlimit(7, (struct rlimit  const  *)(& newrlim));
  if (tmp___4 < 0) {
    perror("setrlimit");
    exit(1);
  } else {
