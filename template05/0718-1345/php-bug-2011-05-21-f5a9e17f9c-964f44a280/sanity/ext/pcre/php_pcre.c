...
{ 
      ...
      if (tmp___9) {
        ...
        while (1) {
          ...
          memcpy((void */* __restrict  */)(__dest___0->c + __dest___0->len),
                 (void const   */* __restrict  */)esc_match,
  ...
  while (1) {
    ...
    memcpy((void */* __restrict  */)(__dest___1->c + __dest___1->len),
           (void const   */* __restrict  */)segment, (size_t )(walk - segment));
    ...
    if (count > 0) {
      ...
      if (limit > 0) {
        ...
        if (new_len + 1 > alloc_len) {
          ...
          memcpy((void */* __restrict  */)new_buf,
                 (void const   */* __restrict  */)result, (size_t )*result_len);
          _efree((void *)result);
          result = new_buf;
        } else {
        ...
        memcpy((void */* __restrict  */)(result + *result_len),
               (void const   */* __restrict  */)piece, (size_t )(match - piece));
        *result_len += match - piece;
        ...
        if (is_callable_replace) {
          _L___1: /* CIL Label */ 
          memcpy((void */* __restrict  */)walkbuf,
                 (void const   */* __restrict  */)eval_result,
            ...
            if (36 == (int )*walk) {
              ...
              if (tmp___4) {
                if (backref < count) {
                  match_len = *(offsets + ((backref << 1) + 1)) - *(offsets + (backref << 1));
                  memcpy((void */* __restrict  */)walkbuf,
                         (void const   */* __restrict  */)(subject + *(offsets + (backref << 1))),
                         (size_t )match_len);
                  walkbuf += match_len;
                } else {
      ...
      if (g_notempty != 0) {
        if (start_offset < subject_len) {
          ...
          *(offsets + 1) = start_offset + 1;
          memcpy((void */* __restrict  */)(result + *result_len),
                 (void const   */* __restrict  */)piece, (size_t )1);
          (*result_len) ++;
        } else {
          goto _L___2;
        }
