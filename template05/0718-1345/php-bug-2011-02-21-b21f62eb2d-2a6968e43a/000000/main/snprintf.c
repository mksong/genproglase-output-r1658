...
int __attribute__((__visibility__("default")))  ap_php_slprintf(char *buf ,
                                                                size_t len ,
                                                                char const   *format 
                                                                , ...) ;
int __attribute__((__visibility__("default")))  ap_php_vslprintf(char *buf ,
                                                                 size_t len ,
                                                                 char const   *format ,
                                                                 va_list ap ) ;
int __attribute__((__visibility__("default")))  ap_php_snprintf(char *buf ,
                                                                size_t len ,
                                                                char const   *format 
                                                                , ...) ;
int __attribute__((__visibility__("default")))  ap_php_vsnprintf(char *buf ,
                                                                 size_t len ,
                                                                 char const   *format ,
                                                                 va_list ap ) ;
int __attribute__((__visibility__("default")))  ap_php_vasprintf(char **buf ,
                                                                 char const   *format ,
                                                                 va_list ap ) ;
int __attribute__((__visibility__("default")))  ap_php_asprintf(char **buf ,
                                                                char const   *format 
                                                                , ...) ;
extern int __attribute__((__visibility__("default")))  ( /* format attribute */  php_sprintf)(char *s ,
                                                                                              char const   *format 
                                                                                              , ...) ;
char __attribute__((__visibility__("default")))  *php_gcvt(double value ,
                                                           int ndigit ,
                                                           char dec_point ,
                                                           char exponent ,
                                                           char *buf ) ;
char __attribute__((__visibility__("default")))  *php_conv_fp(char format ,
                                                              double num ,
                                                              boolean_e add_dp ,
                                                              int precision ,
                                                              char dec_point ,
                                                              ...
                                                              char *buf ,
                                                              int *len ) ;
char *ap_php_conv_10(wide_int num , bool_int is_unsigned ,
                     bool_int *is_negative , char *buf_end , int *len ) ;
char *ap_php_conv_p2(u_wide_int num , int nbits , char format , char *buf_end ,
                     int *len ) ;
...
__inline static char *php_ecvt(double value , int ndigit , int *decpt ,
                               int *sign ) 
{ 
  char *tmp ;
...
__inline static char *php_fcvt(double value , int ndigit , int *decpt ,
                               int *sign ) 
{ 
  char *tmp ;
...
{ 
  ...
  if (decpt == 9999) {
    ...
    ap_php_snprintf(buf, (size_t )(ndigit + 1), "%s%s", tmp___1, tmp___0);
...
{ 
  ...
  if ((int const   )*(*tmp___0 + (int )*p) & 1024) {
    ...
    *len = (int )tmp;
    memcpy((void */* __restrict  */)buf, (void const   */* __restrict  */)p,
           (size_t )(*len + 1));
    *is_negative = 0;
    free((void *)p_orig);
    return ((char __attribute__((__visibility__("default")))  *)buf);
  ...
  if ((int )format != 70) {
    ...
    *tmp___18 = format;
    decimal_point --;
    if (decimal_point != 0) {
      p = ap_php_conv_10((wide_int )decimal_point, 0, & exponent_is_negative,
                         & temp[10], & t_len);
      tmp___19 = s;
      s ++;
...
{ 
  ...
  char *tmp___61 ;
  size_t tmp___62 ;
  long double tmp___63 ;
  long double tmp___64 ;
  double tmp___65 ;
  int tmp___66 ;
  int tmp___67 ;
  int tmp___68 ;
  ...
  int tmp___78 ;
  int tmp___79 ;
  long double tmp___80 ;
  long double tmp___81 ;
  double tmp___82 ;
  int tmp___83 ;
  int tmp___84 ;
  int tmp___85 ;
  ...
  int tmp___93 ;
  int tmp___94 ;
  char __attribute__((__visibility__("default")))  *tmp___95 ;
  char *tmp___96 ;
  size_t tmp___97 ;
  int tmp___98 ;
  void *tmp___99 ;
  ...
  while (*fmt) {
    if ((int const   )*fmt != 37) {
      ...
      if (((int )*fmt & -128) == 0) {
        ...
        if ((int const   )*(*tmp___10 + (int )*fmt) & 512) {
          ...
          if ((int const   )*(*tmp___4 + (int )*fmt) & 2048) {
            tmp___0 = fmt;
            fmt ++;
      ...
      switch ((int const   )*fmt) {
      case 90: 
      tmp___12 = __builtin_va_arg(ap, zval *);
      zvp = tmp___12;
      ...
      default: 
      tmp___14 = __builtin_va_arg(ap, unsigned int );
      i_num = (wide_int )tmp___14;
      break;
      case 6U: 
      goto fmt_error;
      case 5U: 
      tmp___16 = __builtin_va_arg(ap, unsigned long );
      i_num = (wide_int )tmp___16;
      break;
      case 4U: 
      tmp___18 = __builtin_va_arg(ap, size_t );
      i_num = (wide_int )tmp___18;
      break;
      case 3U: 
      tmp___20 = __builtin_va_arg(ap, u_wide_int );
      i_num = (wide_int )tmp___20;
      break;
      case 1U: 
      tmp___22 = __builtin_va_arg(ap, uintmax_t );
      i_num = (wide_int )tmp___22;
      break;
      case 2U: 
      tmp___24 = __builtin_va_arg(ap, ptrdiff_t );
      i_num = (wide_int )tmp___24;
      break;
      }
      case 105: 
      case 100: 
      if ((int const   )*fmt != 117) {
        ...
        i_num = (wide_int )tmp___26;
        break;
        case 6U: 
        goto fmt_error;
        case 5U: 
        tmp___28 = __builtin_va_arg(ap, long );
        i_num = (wide_int )tmp___28;
        break;
        case 4U: 
        tmp___30 = __builtin_va_arg(ap, ssize_t );
        i_num = (wide_int )tmp___30;
        break;
        case 3U: 
        tmp___32 = __builtin_va_arg(ap, wide_int );
        i_num = tmp___32;
        break;
        case 1U: 
        tmp___34 = __builtin_va_arg(ap, intmax_t );
        i_num = tmp___34;
        break;
        case 2U: 
        tmp___36 = __builtin_va_arg(ap, ptrdiff_t );
        i_num = (wide_int )tmp___36;
        break;
        }
      } else {
      ...
      switch ((unsigned int )modifier) {
      default: 
      tmp___38 = __builtin_va_arg(ap, unsigned int );
      ui_num = (u_wide_int )tmp___38;
      break;
      case 6U: 
      goto fmt_error;
      case 5U: 
      tmp___40 = __builtin_va_arg(ap, unsigned long );
      ui_num = (u_wide_int )tmp___40;
      break;
      case 4U: 
      tmp___42 = __builtin_va_arg(ap, size_t );
      ui_num = (u_wide_int )tmp___42;
      break;
      case 3U: 
      tmp___44 = __builtin_va_arg(ap, u_wide_int );
      ui_num = tmp___44;
      break;
      case 1U: 
      tmp___46 = __builtin_va_arg(ap, uintmax_t );
      ui_num = tmp___46;
      break;
      case 2U: 
      tmp___48 = __builtin_va_arg(ap, ptrdiff_t );
      ui_num = (u_wide_int )tmp___48;
      break;
      }
      ...
      switch ((unsigned int )modifier) {
      default: 
      tmp___50 = __builtin_va_arg(ap, unsigned int );
      ui_num = (u_wide_int )tmp___50;
      break;
      case 6U: 
      goto fmt_error;
      case 5U: 
      tmp___52 = __builtin_va_arg(ap, unsigned long );
      ui_num = (u_wide_int )tmp___52;
      break;
      case 4U: 
      tmp___54 = __builtin_va_arg(ap, size_t );
      ui_num = (u_wide_int )tmp___54;
      break;
      case 3U: 
      tmp___56 = __builtin_va_arg(ap, u_wide_int );
      ui_num = tmp___56;
      break;
      case 1U: 
      tmp___58 = __builtin_va_arg(ap, uintmax_t );
      ui_num = tmp___58;
      break;
      case 2U: 
      tmp___60 = __builtin_va_arg(ap, ptrdiff_t );
      ui_num = (u_wide_int )tmp___60;
      break;
      }
      ...
      switch ((unsigned int )modifier) {
      case 6U: 
      tmp___64 = __builtin_va_arg(ap, long double );
      fp_num = (double )tmp___64;
      break;
      case 0U: 
      tmp___65 = __builtin_va_arg(ap, double );
      fp_num = tmp___65;
      break;
      default: 
      goto fmt_error;
      ...
      if (sizeof(fp_num) == sizeof(float )) {
        tmp___75 = __isnanf((float )fp_num);
        tmp___79 = tmp___75;
      } else {
        if (sizeof(fp_num) == sizeof(double )) {
          tmp___76 = __isnan(fp_num);
          tmp___78 = tmp___76;
        } else {
          tmp___77 = __isnanl((long double )fp_num);
          tmp___78 = tmp___77;
        }
        tmp___79 = tmp___78;
      }
      if (tmp___79) {
        ...
        if (sizeof(fp_num) == sizeof(float )) {
          tmp___70 = __isinff((float )fp_num);
          tmp___74 = tmp___70;
        } else {
          if (sizeof(fp_num) == sizeof(double )) {
            tmp___71 = __isinf(fp_num);
            tmp___73 = tmp___71;
          } else {
            tmp___72 = __isinfl((long double )fp_num);
            tmp___73 = tmp___72;
          }
          tmp___74 = tmp___73;
        }
        if (tmp___74) {
          ...
          if ((int const   )*fmt == 102) {
            tmp___66 = (int )*(lconv->decimal_point);
          } else {
            tmp___66 = '.';
          }
          ...
          tmp___69 = php_conv_fp((char )tmp___68, fp_num, alternate_form,
                                 tmp___67, (char )tmp___66, & is_negative,
                                 & num_buf[1], & s_len);
          s = (char *)tmp___69;
          if (is_negative) {
            prefix_char = (char )'-';
      ...
      switch ((unsigned int )modifier) {
      case 6U: 
      tmp___81 = __builtin_va_arg(ap, long double );
      fp_num = (double )tmp___81;
      break;
      case 0U: 
      tmp___82 = __builtin_va_arg(ap, double );
      fp_num = tmp___82;
      break;
      default: 
      goto fmt_error;
      ...
      if (sizeof(fp_num) == sizeof(float )) {
        tmp___88 = __isnanf((float )fp_num);
        tmp___92 = tmp___88;
      } else {
        if (sizeof(fp_num) == sizeof(double )) {
          tmp___89 = __isnan(fp_num);
          tmp___91 = tmp___89;
        } else {
          tmp___90 = __isnanl((long double )fp_num);
          tmp___91 = tmp___90;
        }
        tmp___92 = tmp___91;
      }
      if (tmp___92) {
        ...
        if (sizeof(fp_num) == sizeof(float )) {
          tmp___83 = __isinff((float )fp_num);
          tmp___87 = tmp___83;
        } else {
          if (sizeof(fp_num) == sizeof(double )) {
            tmp___84 = __isinf(fp_num);
            tmp___86 = tmp___84;
          } else {
            tmp___85 = __isinfl((long double )fp_num);
            tmp___86 = tmp___85;
          }
          tmp___87 = tmp___86;
        }
      ...
      if ((int const   )*fmt == 107) {
        ...
        tmp___94 = (int )*(lconv->decimal_point);
      }
      tmp___95 = php_gcvt(fp_num, precision, (char )tmp___94, (char )tmp___93,
                          & num_buf[1]);
      s = (char *)tmp___95;
      if ((int )*s == 45) {
        tmp___96 = s;
        s ++;
        prefix_char = *tmp___96;
      } else
      if (print_sign) {
        prefix_char = (char )'+';
      } else
      ...
      tmp___97 = strlen((char const   *)s);
      s_len = (int )tmp___97;
      if (alternate_form) {
        tmp___100 = __builtin_strchr(s, '.');
        q = tmp___100;
      ...
      break;
      case 99: 
      tmp___102 = __builtin_va_arg(ap, int );
      char_buf[0] = (char )tmp___102;
      s = & char_buf[0];
      s_len = 1;
      pad_char = (char )' ';
      break;
      ...
      break;
      case 110: 
      tmp___104 = __builtin_va_arg(ap, int *);
      *tmp___104 = cc;
      goto skip_output;
      case 112: 
      if (sizeof(char *) <= sizeof(u_wide_int )) {
        tmp___106 = __builtin_va_arg(ap, char *);
        ui_num = (u_wide_int )((size_t )tmp___106);
...
static void strx_printv(int *ccp , char *buf , size_t len ,
                        char const   *format , va_list ap ) 
{ 
  buffy od ;
  int cc ;
...
{ 
  ...
  tmp = ap_php_vsnprintf((char *)((void *)0), (size_t )0, format, ap2);
  cc = (int )tmp;
  __builtin_va_end(ap2);
  *buf = (char *)((void *)0);
  if (cc >= 0) {
    cc ++;
    tmp___2 = malloc((size_t )cc);
    tmp___1 = (char *)tmp___2;
    *buf = tmp___1;
    if ((unsigned int )tmp___1 != (unsigned int )((void *)0)) {
      tmp___0 = ap_php_vsnprintf(*buf, (size_t )cc, format, ap);
      cc = (int )tmp___0;
      if (cc < 0) {
        free((void *)*buf);
        *buf = (char *)((void *)0);
...
{ 
  ...
  {
  __builtin_va_start(ap, format);
  cc = vasprintf((char **/* __restrict  */)buf,
