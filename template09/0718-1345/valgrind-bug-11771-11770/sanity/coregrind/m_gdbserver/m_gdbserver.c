...
enum __anonenum_VgMsgKind_97 {
    Vg_FailMsg = 0,
    Vg_UserMsg = 1,
    Vg_DebugMsg = 2,
    Vg_ClientMsg = 3
} ;
typedef enum __anonenum_VgMsgKind_97 VgMsgKind;
struct __anonstruct_OutputSink_98 {
   Int fd ;
   Bool is_socket ;
};
typedef struct __anonstruct_OutputSink_98 OutputSink;
typedef Int ArenaId;
struct vg_mallinfo {
   int arena ;
   int ordblks ;
...
typedef enum __anonenum_PointKind_99 PointKind;
enum __anonenum_kwd_report_error_100 {
    kwd_report_none = 0,
    kwd_report_all = 1,
    kwd_report_duplicated_matches = 2
} ;
typedef enum __anonenum_kwd_report_error_100 kwd_report_error;
enum __anonenum_FinishReason_101 {
    orderly_finish = 0,
    reset_after_error = 1,
    reset_after_fork = 2
} ;
typedef enum __anonenum_FinishReason_101 FinishReason;
struct __anonstruct_VgdbShared32_102 {
   int vgdb_pid ;
...
typedef struct __anonstruct_VgdbShared32_102 VgdbShared32;
struct __anonstruct_VgdbShared64_103 {
   int vgdb_pid ;
   int volatile   written_by_vgdb ;
   int volatile   seen_by_valgrind ;
...
typedef struct __anonstruct_VgdbShared64_103 VgdbShared64;
typedef VgdbShared32 VgdbShared;
enum __anonenum_VgVgdb_104 {
    Vg_VgdbNo = 0,
    Vg_VgdbYes = 1,
    Vg_VgdbFull = 2
} ;
typedef enum __anonenum_VgVgdb_104 VgVgdb;
enum __anonenum_VgSmc_105 {
    Vg_SmcNone = 0,
    Vg_SmcStack = 1,
    Vg_SmcAll = 2
} ;
typedef enum __anonenum_VgSmc_105 VgSmc;
typedef int __jmp_buf[6];
typedef int __sig_atomic_t;
struct __anonstruct___sigset_t_106 {
   unsigned long __val[1024U / (8U * sizeof(unsigned long ))] ;
};
typedef struct __anonstruct___sigset_t_106 __sigset_t;
...
enum __anonenum_VgSchedReturnCode_107 {
    VgSrc_None = 0,
    VgSrc_ExitThread = 1,
    VgSrc_ExitProcess = 2,
    VgSrc_FatalSig = 3
} ;
typedef enum __anonenum_VgSchedReturnCode_107 VgSchedReturnCode;
typedef VexGuestX86State VexGuestArchState;
struct SyscallStatus;
struct SyscallStatus;
struct SyscallArgs;
struct SyscallArgs;
struct __anonstruct_ThreadArchState_108 {
...
typedef struct __anonstruct_ThreadArchState_108 ThreadArchState;
struct __anonstruct_ThreadOSstate_109 {
   Int lwpid ;
   Int threadgroup ;
   ThreadId parent ;
...
typedef struct __anonstruct_ThreadOSstate_109 ThreadOSstate;
struct SigQueue;
struct __anonstruct_ThreadState_110 {
   ThreadId tid ;
   ThreadStatus status ;
...
typedef struct __anonstruct_ThreadState_110 ThreadState;
struct __anonstruct_FastCacheEntry_111 {
   Addr guest ;
   Addr host ;
};
typedef struct __anonstruct_FastCacheEntry_111 FastCacheEntry;
struct _BBProfEntry {
   Addr64 addr ;
   ULong score ;
};
...
enum __anonenum_Vg_FnNameKind_112 {
    Vg_FnNameNormal = 0,
    Vg_FnNameMain = 1,
    Vg_FnNameBelowMain = 2
} ;
typedef enum __anonenum_Vg_FnNameKind_112 Vg_FnNameKind;
struct __anonstruct_StackBlock_113 {
   PtrdiffT base ;
   SizeT szB ;
   Bool spRel ;
   Bool isVec ;
...
typedef struct __anonstruct_StackBlock_113 StackBlock;
struct __anonstruct_GlobalBlock_114 {
   Addr addr ;
   SizeT szB ;
   Bool isVec ;
   HChar name[16] ;
...
typedef struct __anonstruct_GlobalBlock_114 GlobalBlock;
struct _DebugInfo;
typedef struct _DebugInfo DebugInfo;
enum __anonenum_VgSectKind_115 {
    Vg_SectUnknown = 0,
    Vg_SectText = 1,
    Vg_SectData = 2,
    Vg_SectBSS = 3,
...
typedef enum __anonenum_VgSectKind_115 VgSectKind;
struct _XArray;
...
struct __anonstruct_VgCallbackClosure_118 {
   Addr64 nraddr ;
   Addr64 readdr ;
   ThreadId tid ;
};
typedef struct __anonstruct_VgCallbackClosure_118 VgCallbackClosure;
enum __anonenum_CorePart_119 {
    Vg_CoreStartup = 1,
    Vg_CoreSignal = 2,
    Vg_CoreSysCall = 3,
...
typedef enum __anonenum_CorePart_119 CorePart;
struct __anonstruct_VgDetails_120 {
   Char *name ;
   Char *version ;
   Char *description ;
...
typedef struct __anonstruct_VgDetails_120 VgDetails;
struct __anonstruct_VgNeeds_121 {
   Bool libc_freeres ;
   Bool core_errors ;
   Bool tool_errors ;
...
typedef struct __anonstruct_VgNeeds_121 VgNeeds;
struct __anonstruct_VgToolInterface_122 {
...
typedef struct __anonstruct_VgToolInterface_122 VgToolInterface;
enum __anonenum_SegKind_123 {
    SkFree = 0,
    SkAnonC = 1,
    SkAnonV = 2,
    SkFileC = 3,
...
typedef enum __anonenum_SegKind_123 SegKind;
enum __anonenum_ShrinkMode_124 {
    SmLower = 0,
    SmFixed = 1,
    SmUpper = 2
} ;
typedef enum __anonenum_ShrinkMode_124 ShrinkMode;
struct __anonstruct_NSegment_125 {
   SegKind kind ;
   Addr start ;
   Addr end ;
   ShrinkMode smode ;
...
typedef struct __anonstruct_NSegment_125 NSegment;
enum __anonenum_rkind_127 {
    MFixed = 0,
    MHint = 1,
    MAny = 2
} ;
struct __anonstruct_MapRequest_126 {
   enum __anonenum_rkind_127 rkind ;
   Addr start ;
   Addr len ;
};
typedef struct __anonstruct_MapRequest_126 MapRequest;
struct __anonstruct_AixCodeSegChange_128 {
   Addr code_start ;
   Word code_len ;
   Addr data_start ;
   Word data_len ;
...
typedef struct __anonstruct_AixCodeSegChange_128 AixCodeSegChange;
struct __anonstruct_VgStack_129 {
   HChar bytes[1064960] ;
};
typedef struct __anonstruct_VgStack_129 VgStack;
struct __anonstruct_OrigFn_130 {
   unsigned int nraddr ;
};
typedef struct __anonstruct_OrigFn_130 OrigFn;
enum __anonenum_Vg_ClientRequest_131 {
...
typedef enum __anonenum_Vg_ClientRequest_131 Vg_ClientRequest;
...
enum __anonenum_transfer_direction_132 {
    valgrind_to_gdbserver = 0,
    gdbserver_to_valgrind = 1
} ;
typedef enum __anonenum_transfer_direction_132 transfer_direction;
enum __anonenum_CallReason_133 {
    init_reason = 0,
    vgdb_reason = 1,
    core_reason = 2,
    break_reason = 3,
...
typedef enum __anonenum_CallReason_133 CallReason;
enum __anonenum_GS_Kind_134 {
    GS_break = 0,
    GS_jump = 1
} ;
typedef enum __anonenum_GS_Kind_134 GS_Kind;
struct _GS_Address {
...
{ 
  ...
  vgPlain_discard_translations((Addr64 )addr, (ULong )1, from);
  return;
}
}
...
{ 
  ...
  vgPlain_discard_translations((Addr64 )g->addr, (ULong )1, from);
...
{ 
  ...
  if (tmp) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 212,
...
{ 
  ...
  {
  tmp = vgPlain_HT_lookup(gs_addresses, addr);
  g = (GS_Address *)tmp;
  if (insert) {
  ...
  if ((unsigned int )g != (unsigned int )((void *)0)) {
    if ((unsigned int )g->kind == 0U) {
      tmp___0 = valgrind_single_stepping();
      if (tmp___0) {
        g->kind = (GS_Kind )1;
      } else {
...
{ 
  ...
  if (tmp___8) {
    ...
    vgPlain_assert_fail((Bool )1,
                        ...
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 296,
  ...
  if (insert) {
    ...
    if (tmp___11) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"g != NULL",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 318,
                          (Char const   *)"vgPlain_gdbserver_point", "");
    }
...
{ 
  ...
  if (tmp___0) {
    ...
    vgPlain_assert_fail((Bool )1,
                        (Char const   *)"kind == access_watchpoint || kind == read_watchpoint || kind == write_watchpoint",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 338,
  ...
  while (1) {
    ...
    if (tmp___6) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 392,
                          (Char const   *)"vgPlain_is_watched", "");
    }
    }
  }
...
{ 
  ...
  while (1) {
    tmp___10 = vgPlain_HT_Next(gs_addresses);
    g = (GS_Address *)tmp___10;
    if (g) {
    ...
    while (e < (int )vge->n_used) {
      if ((Addr64 )g->addr >= vge->base[e]) {
        if ((Addr64 )g->addr < vge->base[e] + (Addr64 )vge->len[e]) {
          while (1) {
  ...
  while ((UInt )i < n_elems) {
    ...
    if (tmp___5) {
      ...
      if (tmp___4) {
        ...
        vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                            (Char const   *)"m_gdbserver/m_gdbserver.c", 479,
  ...
  if (gdbserver_called) {
    ...
    if (tmp___3) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"gs_addresses != NULL",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 530,
    ...
    if (tmp___4) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"gs_watches != NULL",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 531,
                          (Char const   *)"gdbserver_cleanup_in_child_after_fork",
                          "");
    }
    ...
    if (tmp___5) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"gs_addresses == NULL",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 539,
                          (Char const   *)"gdbserver_cleanup_in_child_after_fork",
                          "");
    }
    ...
    if (tmp___6) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"gs_watches == NULL",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 540,
                          (Char const   *)"gdbserver_cleanup_in_child_after_fork",
                          "");
    }
  }
...
{ 
  ...
  if (tmp___8) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"VG_(is_valid_tid)(tid)",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 569,
  ...
  if (gdbserver_called == 0) {
    ...
    if (tmp___12) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"gs_addresses == NULL",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 579,
                          (Char const   *)"call_gdbserver", "");
    }
    ...
    if (tmp___13) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"gs_watches == NULL",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 580,
                          (Char const   *)"call_gdbserver", "");
    }
  ...
  if (tmp___14) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"gs_addresses != NULL",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 585,
                        (Char const   *)"call_gdbserver", "");
  }
  ...
  if (tmp___15) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"gs_watches != NULL",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 586,
                        (Char const   *)"call_gdbserver", "");
  }
  gdbserver_called ++;
...
{ 
  ...
  if (tmp___1 != 0) {
    ...
    if (tmp) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 720,
  ...
  if (tmp___2) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 729,
                        (Char const   *)"give_control_back_to_vgdb",
...
{ 
  ...
  if (tmp) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"check == 0x8BADF00D",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 752,
  ...
  while (n_tid < 500) {
    ...
    if (tmp___0) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 782,
                          (Char const   *)"vgPlain_invoke_gdbserver", "");
    }
    }
    n_tid ++;
  ...
  if (tmp___7) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 798,
                        (Char const   *)"vgPlain_invoke_gdbserver",
...
{ 
  ...
  if (tmp___0) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 812,
...
{ 
  ...
  tmp___4 = valgrind_single_stepping();
  if (tmp___4) {
    goto _L;
  } else {
    tmp___5 = vgPlain_HT_lookup(gs_addresses, iaddr);
    g = (GS_Address *)tmp___5;
    if (g) {
      if ((unsigned int )g->kind == 0U) {
        _L: /* CIL Label */ 
...
{ 
  ...
  {
  tmp = mkIRExpr_HWord(iaddr);
  tmp___0 = IRStmt_Put(layout->offset_IP, tmp);
  addStmtToIRSB(irsb, tmp___0);
  fn = (void *)(& vgPlain_helperc_CallDebugger);
  nm = (HChar *)"VG_(helperc_CallDebugger)";
  tmp___1 = mkIRExpr_HWord(iaddr);
  args = mkIRExprVec_1(tmp___1);
  nargs = 1;
  tmp___2 = vgPlain_fnptr_to_fnentry(fn);
  di = unsafeIRDirty_0_N(nargs, nm, tmp___2, args);
  di->nFxState = 2;
...
{ 
  ...
  if ((unsigned int )(sb_in->next)->tag == 86019U) {
    ...
    if (tmp___0) {
      ...
      vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                          (Char const   *)"m_gdbserver/m_gdbserver.c", 1026,
  ...
  while (i < sb_in->stmts_used) {
    ...
    if ((unsigned int )st->tag == 102401U) {
      ...
      if (tmp___1) {
        ...
        vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                            (Char const   *)"m_gdbserver/m_gdbserver.c", 1062,
      ...
      if (tmp___2) {
        ...
        vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                            (Char const   *)"m_gdbserver/m_gdbserver.c", 1078,
                            (Char const   *)"vgPlain_instrument_for_gdbserver_if_needed",
                            "");
      }
      }
...
{ 
  ...
  if (tmp___8) {
    ...
    vgPlain_assert_fail((Bool )1, (Char const   *)"0",
                        (Char const   *)"m_gdbserver/m_gdbserver.c", 1215,
