...
zend_op_array __attribute__((__visibility__("default")))  *compile_file(zend_file_handle *file_handle ,
                                                                        int type ) ;
zend_op_array __attribute__((__visibility__("default")))  *compile_string(zval *source_string ,
                                                                          char *filename ) ;
zend_op_array __attribute__((__visibility__("default")))  *compile_filename(int type ,
                                                                            zval *filename ) ;
...
int __attribute__((__visibility__("default")))  zend_prepare_string_for_scanning(zval *str ,
                                                                                 char *filename ) ;
void __attribute__((__visibility__("default")))  zend_multibyte_yyinput_again(size_t (*old_input_filter)(unsigned char **str ,
                                                                                                         size_t *str_length ,
                                                                                                         unsigned char const   *buf ,
                                                                                                         size_t length ) ,
...
int __attribute__((__visibility__("default")))  highlight_file(char *filename ,
                                                               zend_syntax_highlighter_ini *syntax_highlighter_ini___0 ) ;
int __attribute__((__visibility__("default")))  highlight_string(zval *str ,
                                                                 zend_syntax_highlighter_ini *syntax_highlighter_ini___0 ,
                                                                 char *str_name ) ;
...
static size_t encoding_filter_script_to_internal(unsigned char **to ,
                                                 size_t *to_length ,
                                                 unsigned char const   *from ,
                                                 size_t from_length ) 
{ 
  ...
  if (internal_encoding) {
    ...
    if (tmp___0) {
      ...
      __assert_fail("internal_encoding && zend_multibyte_check_lexer_compatibility(internal_encoding)",
                    "Zend/zend_language_scanner.l", 126U,
  ...
  tmp___1 = zend_multibyte_encoding_converter(to, to_length, from, from_length,
                                              internal_encoding,
                                              language_scanner_globals.script_encoding);
  return ((size_t )tmp___1);
}
}
static size_t encoding_filter_script_to_intermediate(unsigned char **to ,
                                                     size_t *to_length ,
                                                     unsigned char const   *from ,
                                                     size_t from_length ) 
{ 
  ...
  {
  tmp = zend_multibyte_encoding_converter(to, to_length, from, from_length,
                                          (zend_encoding const   *)zend_multibyte_encoding_utf8,
                                          language_scanner_globals.script_encoding);
  return ((size_t )tmp);
}
}
static size_t encoding_filter_intermediate_to_script(unsigned char **to ,
                                                     size_t *to_length ,
                                                     unsigned char const   *from ,
                                                     size_t from_length ) 
{ 
...
static size_t encoding_filter_intermediate_to_internal(unsigned char **to ,
                                                       size_t *to_length ,
                                                       unsigned char const   *from ,
                                                       size_t from_length ) 
{ 
  ...
  if (internal_encoding) {
    ...
    if (tmp___0) {
      ...
      __assert_fail("internal_encoding && zend_multibyte_check_lexer_compatibility(internal_encoding)",
                    "Zend/zend_language_scanner.l", 144U,
...
{ 
  ...
  {
  zend_stack_push(& language_scanner_globals.state_stack,
                  (void const   *)((void *)(& language_scanner_globals.yy_state)),
                  (int )sizeof(int ));
...
{ 
  ...
  {
  zend_stack_top((zend_stack const   *)(& language_scanner_globals.state_stack),
                 (void **)(& stack_state));
...
{ 
  ...
  {
  compiler_globals.parse_error = (zend_bool )0;
...
{ 
  ...
  lex_state->lineno = (uint )compiler_globals.zend_lineno;
...
{ 
  ...
  {
  zend_llist_del_element(& compiler_globals.open_files, (void *)file_handle,
                         (int (*)(void * , void * ))(& zend_compare_file_handles));
...
static zend_encoding const   *zend_multibyte_detect_utf_encoding(unsigned char const   *script ,
                                                                 size_t script_size ) 
{ 
  ...
  while ((size_t )(p - script) < script_size) {
    tmp = memchr((void const   *)p, 0,
                 (script_size - (size_t )(p - script)) - 2U);
...
{ 
  ...
  tmp___3 = memcmp((void const   *)language_scanner_globals.script_org,
                   (void const   *)"\000\000\376\377",
                   sizeof("\000\000\376\377") - 1U);
  if (tmp___3) {
    tmp___2 = memcmp((void const   *)language_scanner_globals.script_org,
                     (void const   *)"\377\376\000\000",
                     sizeof("\377\376\000\000") - 1U);
    if (tmp___2) {
      tmp___1 = memcmp((void const   *)language_scanner_globals.script_org,
                       (void const   *)"\376\377", sizeof("\376\377") - 1U);
      if (tmp___1) {
        tmp___0 = memcmp((void const   *)language_scanner_globals.script_org,
                         (void const   *)"\377\376", sizeof("\377\376") - 1U);
        if (tmp___0) {
          tmp = memcmp((void const   *)language_scanner_globals.script_org,
                       (void const   *)"\357\273\277",
                       sizeof("\357\273\277") - 1U);
          if (tmp) {
  ...
  tmp___7 = memchr((void const   *)language_scanner_globals.script_org, 0,
                   language_scanner_globals.script_org_size);
  pos1 = (unsigned char *)tmp___7;
  if (pos1) {
    pos2 = language_scanner_globals.script_org;
    while ((unsigned int )(pos1 - pos2) >= sizeof("__HALT_COMPILER();") - 1U) {
      tmp___4 = memchr((void const   *)pos2, '_', (size_t )(pos1 - pos2));
      ...
      pos2 ++;
      tmp___5 = strncasecmp((char const   *)((char *)pos2), "_HALT_COMPILER",
                            sizeof("_HALT_COMPILER") - 1U);
      if (tmp___5 == 0) {
    ...
    tmp___6 = zend_multibyte_detect_utf_encoding((unsigned char const   *)language_scanner_globals.script_org,
                                                 language_scanner_globals.script_org_size);
    return (tmp___6);
  } else {
...
{ 
  ...
  if (compiler_globals.script_encoding_list_size > 1U) {
    tmp = zend_multibyte_encoding_detector((unsigned char const   *)language_scanner_globals.script_org,
                                           language_scanner_globals.script_org_size,
...
{ 
  ...
  if ((unsigned int )file_handle->handle.stream.handle >= (unsigned int )((void *)file_handle)) {
    if ((unsigned int )file_handle->handle.stream.handle <= (unsigned int )((void *)(file_handle + 1))) {
      tmp___1 = zend_llist_get_last_ex(& compiler_globals.open_files,
                                       (zend_llist_position *)((void *)0));
  ...
  if (size != 4294967295U) {
    if (compiler_globals.multibyte) {
      ...
      if (language_scanner_globals.input_filter) {
        tmp___3 = (*(language_scanner_globals.input_filter))(& language_scanner_globals.script_filtered,
                                                             & language_scanner_globals.script_filtered_size,
                                                             (unsigned char const   *)language_scanner_globals.script_org,
                                                             language_scanner_globals.script_org_size);
        if (4294967295U == tmp___3) {
          ...
          zend_error_noreturn(1 << 6L,
                              "Could not convert the script from the detected encoding \"%s\" to a compatible encoding",
                              tmp___2);
        } else {
...
{ 
  ...
  retval_znode.u.constant.type = (zend_uchar )1;
  retval_znode.u.constant.value.lval = 1L;
  zval_unset_isref_p(& retval_znode.u.constant);
  zval_set_refcount_p(& retval_znode.u.constant, (zend_uint )1);
  ...
  if (tmp___0 == (int __attribute__((__visibility__("default")))  )-1) {
    if (type == 1 << 3) {
      ...
      _zend_bailout((char *)"Zend/zend_language_scanner.l", (uint )569);
    } else {
    ...
    if (compiler_result == 1) {
      _zend_bailout((char *)"Zend/zend_language_scanner.l", (uint )583);
    } else {

    }
    compilation_successful = (zend_bool )1;
  }
  if (retval) {
...
{ 
  ...
  if (retval) {
    if (file_handle.handle.stream.handle) {
      dummy = 1;
      if (! file_handle.opened_path) {
        tmp___1 = _estrndup((char const   *)filename->value.str.val,
                            (unsigned int )filename->value.str.len);
      ...
      _zend_hash_add_or_update(& executor_globals.included_files,
                               (char const   *)file_handle.opened_path,
                               tmp___2 + 1U, (void *)(& dummy), sizeof(int ),
                               (void **)((void *)0), 1 << 1);
      if (opened_path) {
...
{ 
  ...
  if ((unsigned int )str->value.str.val >= (unsigned int )compiler_globals.interned_strings_start) {
    if ((unsigned int )str->value.str.val < (unsigned int )compiler_globals.interned_strings_end) {
      tmp___0 = _safe_emalloc((size_t )1, (size_t )str->value.str.len,
                              (size_t )32);
      tmp = (char *)tmp___0;
      memcpy((void */* __restrict  */)tmp,
             (void const   */* __restrict  */)str->value.str.val,
             (size_t )(str->value.str.len + 32));
      str->value.str.val = tmp;
    } else {
      tmp___1 = _safe_erealloc((void *)str->value.str.val, (size_t )1,
                               (size_t )str->value.str.len, (size_t )32);
  ...
  memset((void *)(str->value.str.val + str->value.str.len), 0, (size_t )32);
  language_scanner_globals.yy_in = (zend_file_handle *)((void *)0);
  language_scanner_globals.yy_start = (unsigned char *)((void *)0);
  buf = str->value.str.val;
  size = (size_t )str->value.str.len;
  if (compiler_globals.multibyte) {
    language_scanner_globals.script_org = (unsigned char *)buf;
    language_scanner_globals.script_org_size = size;
    language_scanner_globals.script_filtered = (unsigned char *)((void *)0);
    ...
    if (language_scanner_globals.input_filter) {
      tmp___4 = (*(language_scanner_globals.input_filter))(& language_scanner_globals.script_filtered,
                                                           & language_scanner_globals.script_filtered_size,
                                                           (unsigned char const   *)language_scanner_globals.script_org,
                                                           language_scanner_globals.script_org_size);
...
{ 
  ...
  if (language_scanner_globals.input_filter) {
    ...
    while (1) {
      ...
      tmp = (*(language_scanner_globals.input_filter))(& p, & length,
                                                       (unsigned char const   *)language_scanner_globals.script_org,
                                                       offset);
      if (4294967295U == tmp) {
        return ((size_t __attribute__((__visibility__("default")))  )((size_t )-1));
      } else {
  ...
  return ((size_t __attribute__((__visibility__("default")))  )offset);
}
}
zend_op_array __attribute__((__visibility__("default")))  *compile_string(zval *source_string ,
                                                                          char *filename ) 
{ 
  ...
  if (tmp___1 == (int __attribute__((__visibility__("default")))  )-1) {
    ...
    init_op_array(op_array, (zend_uchar )4, 64);
    ...
    if (compiler_result == 1) {
      compiler_globals.active_op_array = original_active_op_array;
      compiler_globals.unclean_shutdown = (zend_bool )1;
...
{ 
  ...
  if (! language_scanner_globals.input_filter) {
    ...
    language_scanner_globals.script_filtered_size = (size_t )0;
    length = language_scanner_globals.script_org_size;
    new_yy_start = language_scanner_globals.script_org;
  } else {
    tmp___0 = (*(language_scanner_globals.input_filter))(& new_yy_start,
                                                         & length,
                                                         (unsigned char const   *)language_scanner_globals.script_org,
                                                         language_scanner_globals.script_org_size);
...
{ 
  ...
  while (1) {
    tmp = memchr((void const   *)language_scanner_globals.yy_cursor, '<',
                 (size_t )(language_scanner_globals.yy_limit - language_scanner_globals.yy_cursor));
  ...
  while ((unsigned int )language_scanner_globals.yy_cursor < (unsigned int )language_scanner_globals.yy_limit) {
    ...
    if ((int )*(language_scanner_globals.yy_cursor) >= 127) {
      break;
    } else
    ...
    if ((int )*(language_scanner_globals.yy_cursor) >= 127) {
      ...
      if (compiler_globals.heredoc_len < language_scanner_globals.yy_limit - language_scanner_globals.yy_cursor) {
        tmp___13 = memcmp((void const   *)language_scanner_globals.yy_cursor,
                          ...
                          (size_t )compiler_globals.heredoc_len);
        if (tmp___13) {
  ...
  if (language_scanner_globals.yy_leng < 10U) {
    ...
    *tmp___19 = 0;
    ...
    if (*tmp___22 == 34) {
      ...
      zendlval->type = (zend_uchar )2;
      return ((int __attribute__((__visibility__("default")))  )306);
    } else {

    }
  }
  zendlval->type = (zend_uchar )1;
  ...
  *t = (char)0;
  ...
  zend_error(1 << 7L,
             ...
             (int )*((char *)language_scanner_globals.yy_text + 0),
             (int )*((char *)language_scanner_globals.yy_text + 0),
  ...
  if (0) {
    ...
    __s2_len = strlen(".");
    if (! ((size_t )((void const   *)(dirname + 1)) - (size_t )((void const   *)dirname) == 1U)) {
      goto _L___12;
    } else
    if (__s1_len >= 4U) {
      _L___12: /* CIL Label */ 
  ...
  if (tmp___53 == 0) {
    tmp___47 = _erealloc((void *)dirname, (size_t )4096, 0);
    dirname = (char *)tmp___47;
    getcwd(dirname, (size_t )4096);
  } else {
  ...
  if (language_scanner_globals.output_filter) {
    ...
    (*(language_scanner_globals.output_filter))((unsigned char **)(& zendlval->value.str.val),
                                                & sz___14,
                                                (unsigned char const   *)((unsigned char *)((char *)language_scanner_globals.yy_text)),
                                                language_scanner_globals.yy_leng - (size_t )newline___0);
  ...
  if (language_scanner_globals.yy_leng == 10U) {
    if (0) {
      ...
      if (! ((size_t )((void const   *)((char *)language_scanner_globals.yy_text + 1)) - (size_t )((void const   *)((char *)language_scanner_globals.yy_text)) == 1U)) {
        goto _L___19;
      } else
      if (__s1_len___0 >= 4U) {
        _L___19: /* CIL Label */ 
