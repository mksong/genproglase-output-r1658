...
int __attribute__((__visibility__("default")))  php_stream_context_set_option(php_stream_context *context ,
                                                                              ...
                                                                              char const   *optionname ,
                                                                              zval *optionvalue ) ;
int __attribute__((__visibility__("default")))  php_stream_context_get_link(php_stream_context *context ,
                                                                            char const   *hostent ,
                                                                            php_stream **stream ) ;
int __attribute__((__visibility__("default")))  php_stream_context_set_link(php_stream_context *context ,
                                                                            char const   *hostent ,
                                                                            php_stream *stream ) ;
int __attribute__((__visibility__("default")))  php_stream_context_del_link(php_stream_context *context ,
                                                                            php_stream *stream ) ;
...
size_t __attribute__((__visibility__("default")))  _php_stream_write(php_stream *stream ,
                                                                     char const   *buf ,
                                                                     size_t count ) ;
size_t __attribute__((__visibility__("default")))  ( /* format attribute */  _php_stream_printf)(php_stream *stream ,
                                                                                                 char const   *fmt 
                                                                                                 , ...) ;
...
size_t __attribute__((__visibility__("default")))  _php_stream_copy_to_stream_ex(php_stream *src ,
                                                                                 php_stream *dest ,
                                                                                 size_t maxlen ,
                                                                                 size_t *len ) ;
...
char __attribute__((__visibility__("default")))  *php_stream_locate_eol(php_stream *stream ,
                                                                        char *buf ,
                                                                        size_t buf_len ) ;
void __attribute__((__visibility__("default")))  ( /* format attribute */  php_stream_wrapper_log_error)(php_stream_wrapper *wrapper ,
                                                                                                         int options ,
                                                                                                         char const   *fmt 
                                                                                                         , ...) ;
...
extern void php_stream_mode_sanitize_fdopen_fopencookie(php_stream *stream ,
                                                        char *result ) ;
...
{ 
  ...
  tmp___1 = zend_hash_find((HashTable const   *)(& executor_globals.persistent_list),
                           (char const   *)((char *)persistent_id),
                           tmp___0 + 1U, (void **)((void *)(& le)));
  if (tmp___1 == (int __attribute__((__visibility__("default")))  )0) {
    if (le->type == le_pstream) {
      if (stream) {
        *stream = (php_stream *)le->ptr;
        (le->refcount) ++;
        tmp = zend_register_resource((zval *)((void *)0), (void *)*stream,
                                     le_pstream);
      ...
      *(msg + 0) = (char )'\000';
      ...
      while (i < wrapper->err_count) {
        strcat((char */* __restrict  */)msg,
               (char const   */* __restrict  */)*(wrapper->err_stack + i));
        if (i < wrapper->err_count - 1) {
          strcat((char */* __restrict  */)msg,
                 (char const   */* __restrict  */)br);
        } else {
...
{ 
  ...
  if ((unsigned int )wrapper == (unsigned int )((void *)0)) {
    ...
    tmp = _erealloc((void *)wrapper->err_stack,
                    (unsigned int )(wrapper->err_count + 1) * sizeof(char *), 0);
...
{ 
  ...
  if (stream->readfilters.head) {
    ...
    while (1) {
      ...
      while (brig_inp->head) {
        ...
        stream->writepos = (off_t )((unsigned long )stream->writepos + (unsigned long )bucket->buflen);
  ...
  if (stream->writepos - stream->readpos < (off_t )size) {
    ...
    if (stream->readbuf) {
      if ((unsigned long )stream->readbuflen - (unsigned long )stream->writepos < (unsigned long )stream->chunk_size) {
        memmove((void *)stream->readbuf,
                ...
                (size_t )((unsigned long )stream->readbuflen - (unsigned long )stream->readpos));
    ...
    justread___0 = (*((stream->ops)->read))(stream,
                                            ...
                                            (size_t )((unsigned long )stream->readbuflen - (unsigned long )stream->writepos));
    if (justread___0 != 4294967295U) {
      stream->writepos = (off_t )((unsigned long )stream->writepos + (unsigned long )justread___0);
    } else {
...
{ 
  ...
  while (size > 0U) {
    if (stream->writepos > stream->readpos) {
      ...
      memcpy((void */* __restrict  */)buf,
             ...
             toread);
      stream->readpos = (off_t )((unsigned long )stream->readpos + (unsigned long )toread);
      size -= toread;
      buf += toread;
      didread += toread;
    } else {
  ...
  if (didread > 0U) {
    stream->position = (off_t )((unsigned long )stream->position + (unsigned long )didread);
  } else {
...
{ 
  ...
  while (1) {
    ...
    if (avail > 0U) {
      ...
      stream->position = (off_t )((unsigned long )stream->position + (unsigned long )cpysz);
      stream->readpos = (off_t )((unsigned long )stream->readpos + (unsigned long )cpysz);
      buf += cpysz;
      maxlen -= cpysz;
      total_copied += cpysz;
      if (done) {
...
{ 
  ...
  {
  skip = 0;
  len = (size_t )(stream->writepos - stream->readpos);
  while (len < maxlen) {
    ...
    just_read = (size_t )((unsigned long )(stream->writepos - stream->readpos) - (unsigned long )len);
    len += just_read;
    if (just_read < toread) {
      break;
    } else {
  ...
  if (! delim) {
    ...
    if (delim_len == 1U) {
      tmp = memchr((void const   *)(stream->readbuf + stream->readpos),
                   (int )*delim, seek_len);
      e = (char *)tmp;
    } else {
      e = zend_memnstr((char *)(stream->readbuf + stream->readpos), delim,
                       (int )delim_len,
    ...
    if (! e) {
      ...
      toread = (size_t )((off_t )(e - (char *)stream->readbuf) - stream->readpos);
      skip = 1;
    }
  }
  if (toread > maxlen) {
  ...
  *returned_len = (size_t )tmp___1;
  if (skip) {
    stream->readpos = (off_t )((unsigned long )stream->readpos + (unsigned long )delim_len);
    stream->position = (off_t )((unsigned long )stream->position + (unsigned long )delim_len);
  } else {
...
{ 
  ...
  while (count > 0U) {
    ...
    if ((int )justwrote > 0) {
      ...
      if ((stream->ops)->seek) {
        if ((stream->flags & 1) == 0) {
          stream->position = (off_t )((unsigned long )stream->position + (unsigned long )justwrote);
        } else {
  ...
  if (whence == 1) {
    if (offset > 0L) {
      while (offset > 0L) {
        ...
        tmp___2 = _php_stream_read(stream, tmp___0, (size_t )tmp___1);
        ...
        offset = (off_t )((unsigned long )offset - (unsigned long )didread);
      }
      stream->eof = 0;
      return ((int __attribute__((__visibility__("default")))  )0);
    } else {
  ...
  if (stream->writefilters.head) {
    ...
    if (tmp___2) {
      ...
      tmp___0 = _php_stream_mmap_range(stream, (size_t )tmp, (size_t )0,
                                       (php_stream_mmap_operation_t )2, & mapped);
      p = (char *)tmp___0;
      if (p) {
    ...
    if (tmp___4) {
      ...
      if (p) {
        ...
        *len = mapped;
        ...
        return ((size_t __attribute__((__visibility__("default")))  )-1);
      } else {
    ...
    if (n > 1) {
      if (0) {
        if (0) {
          ...
          if (__s1_len >= 4U) {
            _L___0: /* CIL Label */ 
            if (! ((size_t )((void const   *)((p + 1) + 1)) - (size_t )((void const   *)(p + 1)) == 1U)) {
              tmp___11 = 1;
            } else
            if (__s2_len >= 4U) {
              tmp___11 = 1;
...
{ 
  ...
  if (flags & 1) {
    if (basic_globals.CurrentLStatFile) {
      if (0) {
        ...
        if (! ((size_t )((void const   *)(path + 1)) - (size_t )((void const   *)path) == 1U)) {
          goto _L___0;
        } else
        if (__s1_len >= 4U) {
          _L___0: /* CIL Label */ 
          if (! ((size_t )((void const   *)(basic_globals.CurrentLStatFile + 1)) - (size_t )((void const   *)basic_globals.CurrentLStatFile) == 1U)) {
            tmp___5 = 1;
          } else
          if (__s2_len >= 4U) {
            tmp___5 = 1;
  ...
  if (basic_globals.CurrentStatFile) {
    if (0) {
      ...
      if (__s1_len___0 >= 4U) {
        _L___2: /* CIL Label */ 
        if (! ((size_t )((void const   *)(basic_globals.CurrentStatFile + 1)) - (size_t )((void const   *)basic_globals.CurrentStatFile) == 1U)) {
          tmp___12 = 1;
        } else
        if (__s2_len___0 >= 4U) {
          tmp___12 = 1;
...
{ 
  ...
  tmp___0 = zend_hash_find((HashTable const   *)(context->options)->value.ht,
                           (char const   *)((char *)wrappername), tmp + 1U,
                           (void **)(& wrapperhash));
  if (-1 == (int )tmp___0) {
    return ((int __attribute__((__visibility__("default")))  )-1);
  } else {
  ...
  tmp___2 = zend_hash_find((HashTable const   *)(*wrapperhash)->value.ht,
                           (char const   *)((char *)optionname), tmp___1 + 1U,
                           (void **)optionvalue);
  return (tmp___2);
}
}
...
{ 
  ...
  *copied_val = *optionvalue;
  ...
  tmp___4 = zend_hash_find((HashTable const   *)(context->options)->value.ht,
                           (char const   *)((char *)wrappername), tmp___3 + 1U,
                           (void **)(& wrapperhash));
  if (-1 == (int )tmp___4) {
    while (1) {
      tmp___0 = _emalloc(sizeof(zval_gc_info ));
...
{ 
  ...
  tmp = strlen(hostent);
  tmp___0 = zend_hash_find((HashTable const   *)(context->links)->value.ht,
                           (char const   *)((char *)hostent), tmp + 1U,
                           (void **)(& pstream));
  if (0 == (int )tmp___0) {
    *stream = *pstream;
    return ((int __attribute__((__visibility__("default")))  )0);
...
{ 
  ...
  if (! context->links) {
    ...
    *(context->links) = (zval )zval_used_for_init;
    _array_init(context->links, (uint )0);
  } else {

  }
  if (! stream) {
    tmp___0 = strlen(hostent);
    tmp___1 = zend_hash_del_key_or_index((context->links)->value.ht,
                                         (char const   *)((char *)hostent),
                                         tmp___0 + 1U, (ulong )0, 0);
    return (tmp___1);
  } else {

  }
  tmp___2 = strlen(hostent);
  tmp___3 = _zend_hash_add_or_update((context->links)->value.ht,
                                     (char const   *)((char *)hostent),
                                     tmp___2 + 1U,
                                     (void *)((void **)(& stream)),
                                     sizeof(php_stream *), (void **)((void *)0),
                                     1);
  return (tmp___3);
}
}
...
{ 
  ...
  zend_hash_internal_pointer_reset_ex((context->links)->value.ht,
                                      (HashPosition *)((void *)0));
  while (1) {
    tmp___2 = zend_hash_get_current_data_ex((context->links)->value.ht,
                                            (void **)(& pstream),
                                            (HashPosition *)((void *)0));
    if (0 == (int )tmp___2) {
    ...
    if ((unsigned int )*pstream == (unsigned int )stream) {
      tmp___1 = zend_hash_get_current_key_ex((HashTable const   *)(context->links)->value.ht,
                                             & hostent, (uint *)((void *)0),
                                             (ulong *)((void *)0),
                                             (zend_bool )0,
                                             (HashPosition *)((void *)0));
      if (0 == (int )tmp___1) {
        ...
        tmp___0 = zend_hash_del_key_or_index((context->links)->value.ht,
                                             (char const   *)hostent, tmp + 1U,
                                             (ulong )0, 0);
        if (-1 == (int )tmp___0) {
          ret = -1;
        } else {
    ...
    zend_hash_move_forward_ex((context->links)->value.ht,
                              (HashPosition *)((void *)0));
  }
  return ((int __attribute__((__visibility__("default")))  )ret);
}
  ...
  while (1) {
    ...
    if (nfiles == vector_size) {
      ...
      tmp___0 = _erealloc((void *)vector,
                          (unsigned int )vector_size * sizeof(char *), 0);
      vector = (char **)tmp___0;
    } else {
