...
extern int __attribute__((__visibility__("default")))  php_network_getaddresses(char const   *host ,
                                                                                int socktype ,
                                                                                struct sockaddr ***sal ,
                                                                                char **error_string ) ;
...
{ 
  ...
  tmp = zend_parse_parameters(ht, "p|b", & filename, & filename_len,
                              & use_include_path);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    return;
  } else {
      ...
      if ((unsigned int )tok_last == 4U) {
        if (looking_for_val) {
          ...
          if (saw_content) {
            ...
            tmp___8 = _estrndup((char const   *)md.token_data,
                                (unsigned int )md.token_len);
            value = (char *)tmp___8;
            have_content = 1;
          } else {
      ...
      if ((unsigned int )tok_last == 4U) {
        if (looking_for_val) {
          if (saw_name) {
            ...
            tmp___11 = _estrndup((char const   *)md.token_data,
                                 (unsigned int )md.token_len);
            name = (char *)tmp___11;
            temp = name;
            while (1) {
          ...
          if (saw_content) {
            ...
            tmp___14 = _estrndup((char const   *)md.token_data,
                                 (unsigned int )md.token_len);
            value = (char *)tmp___14;
            have_content = 1;
          } else {
    ...
    if ((unsigned int )tok == 2U) {
      if (have_name) {
        ...
        if (have_content) {
          ...
          add_assoc_string_ex(return_value, (char const   *)name, tmp___16 + 1U,
                              value, 1);
        } else {
          tmp___17 = strlen((char const   *)name);
          add_assoc_string_ex(return_value, (char const   *)name, tmp___17 + 1U,
                              (char *)"", 1);
        }
        _efree((void *)name);
        if (value) {
...
{ 
  ...
  tmp = zend_parse_parameters(ht, "p|br!ll", & filename, & filename_len,
  ...
  tmp___9 = _php_stream_copy_to_mem(stream, & contents, (size_t )maxlen, 0);
  len = (int )tmp___9;
  if (len > 0) {
    while (1) {
...
{ 
  ...
  mode[1] = (char )'b';
  mode[2] = (char )'\000';
  tmp = zend_parse_parameters(ht, "pz/|lr!", & filename, & filename_len, & data,
                              & flags, & zcontext);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    return;
  } else {
...
{ 
  ...
  _array_init(return_value, (uint )0);
  tmp___14 = _php_stream_copy_to_mem(stream, & target_buf, (size_t )-1, 0);
    ...
    if (include_new_line) {
      while (1) {
        ...
        add_index_stringl(return_value, (ulong )tmp___9,
                          (char const   *)tmp___8, (uint )(p - s), 0);
        s = p;
        tmp___10 = memchr((void const   *)p, (int )eol_marker, (size_t )(e - p));
        p = (char *)tmp___10;
        if (p) {
      ...
      while (1) {
        ...
        tmp___12 = i;
        i ++;
        add_index_stringl(return_value, (ulong )tmp___12,
                          (char const   *)tmp___11,
                          (uint )((p - s) - windows_eol), 0);
        p ++;
        s = p;
        __Cont: /* CIL Label */ 
        tmp___13 = memchr((void const   *)p, (int )eol_marker, (size_t )(e - p));
        p = (char *)tmp___13;
        if (p) {
...
{ 
  ...
  php_basename((char const   *)prefix, (size_t )prefix_len, (char *)((void *)0),
               (size_t )0, & p, & p_len);
  if (p_len > 64U) {
    *(p + 63) = (char )'\000';
  } else {
...
{ 
  ...
  zcontext = (zval *)((void *)0);
  context = (php_stream_context *)((void *)0);
  tmp = zend_parse_parameters(ht, "ps|br", & filename, & filename_len, & mode,
...
{ 
  ...
  {
  {
  tmp = zend_parse_parameters(ht, "ps", & command, & command_len, & mode,
                              & mode_len);
  if (mode_len < 0) {
    return;
  }
...
{ 
  ...
  tmp___7 = _php_stream_write(stream, (char const   *)tmp___6,
                              (size_t )num_bytes);
  ret = (int )tmp___7;
  if (buffer) {
    _efree((void *)buffer);
...
{ 
  ...
  tmp = zend_parse_parameters(ht, "p|lbr", & dir, & dir_len, & mode,
                              & recursive, & zcontext);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    while (1) {
      __z = return_value;
...
{ 
  ...
  zcontext = (zval *)((void *)0);
  context = (php_stream_context *)((void *)0);
  tmp = zend_parse_parameters(ht, "p|br!", & filename, & filename_len,
...
{ 
  ...
  zcontext = (zval *)((void *)0);
  {
  tmp = zend_parse_parameters(ht, "pp|r", & source, & source_len, & target,
                              & target_len, & zcontext);
  if (target_len < 0) {
    return;
  }
...
{ 
  ...
  while (len > 0U) {
    ...
    case -2: 
    inc_len = 1;
    tmp___0 = mblen((char const   *)((void *)0), (size_t )0);
    __x = tmp___0;
    break;
    case 0: 
    goto quit_loop;
...
{ 
  ...
  tmp = mblen((char const   *)((void *)0), (size_t )0);
  __x = tmp;
  bptr = buf;
  ...
  while (1) {
    ...
    if ((unsigned int )bptr < (unsigned int )limit) {
      if ((int )*bptr == 0) {
        ...
        tmp___2 = mblen((char const   *)bptr, (size_t )(limit - bptr));
        tmp___3 = tmp___2;
      }
      inc_len = tmp___3;
    } else {
    ...
    if (inc_len != 0) {
      if ((int )*bptr == (int )enclosure) {
        ...
        while (1) {
          ...
          if ((unsigned int )stream == (unsigned int )((void *)0)) {
            ...
            tmp___6 = _php_stream_get_line(stream, (char *)((void *)0),
                                           (size_t )0, & new_len);
          ...
          case -1: 
          case -2: 
          tmp___9 = mblen((char const   *)((void *)0), (size_t )0);
          __x___0 = tmp___9;
          case 1: 
          switch (state) {
          case 1: 
          ...
          if ((unsigned int )bptr < (unsigned int )limit) {
            if ((int )*bptr == 0) {
              ...
              tmp___10 = mblen((char const   *)bptr, (size_t )(limit - bptr));
              tmp___11 = tmp___10;
            }
            inc_len = tmp___11;
          } else {
        ...
        while (1) {
          ...
          case -2: 
          inc_len = 1;
          tmp___12 = mblen((char const   *)((void *)0), (size_t )0);
          __x___1 = tmp___12;
          case 1: 
          ...
          if ((unsigned int )bptr < (unsigned int )limit) {
            if ((int )*bptr == 0) {
              ...
              tmp___13 = mblen((char const   *)bptr, (size_t )(limit - bptr));
              tmp___14 = tmp___13;
            }
            inc_len = tmp___14;
          } else {
      ...
      while (1) {
        ...
        case -2: 
        inc_len = 1;
        tmp___15 = mblen((char const   *)((void *)0), (size_t )0);
        __x___2 = tmp___15;
        case 1: 
        if ((int )*bptr == (int )delimiter) {
          goto quit_loop_4;
        ...
        if ((unsigned int )bptr < (unsigned int )limit) {
          if ((int )*bptr == 0) {
            ...
            tmp___16 = mblen((char const   *)bptr, (size_t )(limit - bptr));
            tmp___17 = tmp___16;
          }
          inc_len = tmp___17;
        } else {
...
{ 
  ...
  {
  flags = 0L;
  tmp = zend_parse_parameters(ht, "pp|l", & pattern, & pattern_len, & filename,
                              & filename_len, & flags);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    return;
  } else {
