...
void __attribute__((__visibility__("default")))  zend_fetch_debug_backtrace(zval *return_value ,
                                                                            int skip_last ,
                                                                            int options ,
                                                                            int limit ) ;
...
static void zif_zend_version(int ht , zval *return_value ,
                             zval **return_value_ptr , zval *this_ptr ,
                             int return_value_used ) ;
static void zif_func_num_args(int ht , zval *return_value ,
                              zval **return_value_ptr , zval *this_ptr ,
                              int return_value_used ) ;
...
static void zif_func_get_args(int ht , zval *return_value ,
                              zval **return_value_ptr , zval *this_ptr ,
                              int return_value_used ) ;
static void zif_strlen(int ht , zval *return_value , zval **return_value_ptr ,
                       zval *this_ptr , int return_value_used ) ;
static void zif_strcmp(int ht , zval *return_value , zval **return_value_ptr ,
                       zval *this_ptr , int return_value_used ) ;
static void zif_strncmp(int ht , zval *return_value , zval **return_value_ptr ,
                        zval *this_ptr , int return_value_used ) ;
static void zif_strcasecmp(int ht , zval *return_value ,
                           zval **return_value_ptr , zval *this_ptr ,
                           int return_value_used ) ;
static void zif_strncasecmp(int ht , zval *return_value ,
                            zval **return_value_ptr , zval *this_ptr ,
                            int return_value_used ) ;
static void zif_each(int ht , zval *return_value , zval **return_value_ptr ,
                     zval *this_ptr , int return_value_used ) ;
static void zif_error_reporting(int ht , zval *return_value ,
                                zval **return_value_ptr , zval *this_ptr ,
                                int return_value_used ) ;
static void zif_define(int ht , zval *return_value , zval **return_value_ptr ,
                       zval *this_ptr , int return_value_used ) ;
static void zif_defined(int ht , zval *return_value , zval **return_value_ptr ,
                        zval *this_ptr , int return_value_used ) ;
static void zif_get_class(int ht , zval *return_value ,
                          zval **return_value_ptr , zval *this_ptr ,
                          int return_value_used ) ;
static void zif_get_called_class(int ht , zval *return_value ,
                                 zval **return_value_ptr , zval *this_ptr ,
                                 int return_value_used ) ;
static void zif_get_parent_class(int ht , zval *return_value ,
                                 zval **return_value_ptr , zval *this_ptr ,
                                 int return_value_used ) ;
static void zif_method_exists(int ht , zval *return_value ,
                              zval **return_value_ptr , zval *this_ptr ,
                              int return_value_used ) ;
static void zif_property_exists(int ht , zval *return_value ,
                                zval **return_value_ptr , zval *this_ptr ,
                                int return_value_used ) ;
static void zif_class_exists(int ht , zval *return_value ,
                             zval **return_value_ptr , zval *this_ptr ,
                             int return_value_used ) ;
static void zif_interface_exists(int ht , zval *return_value ,
                                 zval **return_value_ptr , zval *this_ptr ,
                                 int return_value_used ) ;
static void zif_trait_exists(int ht , zval *return_value ,
                             zval **return_value_ptr , zval *this_ptr ,
                             int return_value_used ) ;
static void zif_function_exists(int ht , zval *return_value ,
                                zval **return_value_ptr , zval *this_ptr ,
                                int return_value_used ) ;
static void zif_class_alias(int ht , zval *return_value ,
                            zval **return_value_ptr , zval *this_ptr ,
                            int return_value_used ) ;
static void zif_get_included_files(int ht , zval *return_value ,
                                   zval **return_value_ptr , zval *this_ptr ,
                                   int return_value_used ) ;
static void zif_is_subclass_of(int ht , zval *return_value ,
                               zval **return_value_ptr , zval *this_ptr ,
                               int return_value_used ) ;
static void zif_is_a(int ht , zval *return_value , zval **return_value_ptr ,
                     zval *this_ptr , int return_value_used ) ;
static void zif_get_class_vars(int ht , zval *return_value ,
                               zval **return_value_ptr , zval *this_ptr ,
                               int return_value_used ) ;
static void zif_get_object_vars(int ht , zval *return_value ,
                                zval **return_value_ptr , zval *this_ptr ,
                                int return_value_used ) ;
static void zif_get_class_methods(int ht , zval *return_value ,
                                  zval **return_value_ptr , zval *this_ptr ,
                                  int return_value_used ) ;
static void zif_trigger_error(int ht , zval *return_value ,
                              zval **return_value_ptr , zval *this_ptr ,
                              int return_value_used ) ;
static void zif_set_error_handler(int ht , zval *return_value ,
                                  zval **return_value_ptr , zval *this_ptr ,
                                  int return_value_used ) ;
static void zif_restore_error_handler(int ht , zval *return_value ,
                                      zval **return_value_ptr , zval *this_ptr ,
                                      int return_value_used ) ;
static void zif_set_exception_handler(int ht , zval *return_value ,
                                      zval **return_value_ptr , zval *this_ptr ,
                                      int return_value_used ) ;
static void zif_restore_exception_handler(int ht , zval *return_value ,
                                          zval **return_value_ptr ,
                                          zval *this_ptr ,
                                          int return_value_used ) ;
static void zif_get_declared_classes(int ht , zval *return_value ,
                                     zval **return_value_ptr , zval *this_ptr ,
                                     int return_value_used ) ;
static void zif_get_declared_traits(int ht , zval *return_value ,
                                    zval **return_value_ptr , zval *this_ptr ,
                                    int return_value_used ) ;
static void zif_get_declared_interfaces(int ht , zval *return_value ,
                                        zval **return_value_ptr ,
                                        zval *this_ptr , int return_value_used ) ;
static void zif_get_defined_functions(int ht , zval *return_value ,
                                      zval **return_value_ptr , zval *this_ptr ,
                                      int return_value_used ) ;
static void zif_get_defined_vars(int ht , zval *return_value ,
                                 zval **return_value_ptr , zval *this_ptr ,
                                 int return_value_used ) ;
static void zif_create_function(int ht , zval *return_value ,
                                zval **return_value_ptr , zval *this_ptr ,
                                int return_value_used ) ;
static void zif_get_resource_type(int ht , zval *return_value ,
                                  zval **return_value_ptr , zval *this_ptr ,
                                  int return_value_used ) ;
static void zif_get_loaded_extensions(int ht , zval *return_value ,
                                      zval **return_value_ptr , zval *this_ptr ,
                                      int return_value_used ) ;
static void zif_extension_loaded(int ht , zval *return_value ,
                                 zval **return_value_ptr , zval *this_ptr ,
                                 int return_value_used ) ;
static void zif_get_extension_funcs(int ht , zval *return_value ,
                                    zval **return_value_ptr , zval *this_ptr ,
                                    int return_value_used ) ;
static void zif_get_defined_constants(int ht , zval *return_value ,
                                      zval **return_value_ptr , zval *this_ptr ,
                                      int return_value_used ) ;
static void zif_debug_backtrace(int ht , zval *return_value ,
                                zval **return_value_ptr , zval *this_ptr ,
                                int return_value_used ) ;
static void zif_debug_print_backtrace(int ht , zval *return_value ,
                                      zval **return_value_ptr , zval *this_ptr ,
                                      int return_value_used ) ;
static void zif_gc_collect_cycles(int ht , zval *return_value ,
                                  zval **return_value_ptr , zval *this_ptr ,
                                  int return_value_used ) ;
static void zif_gc_enabled(int ht , zval *return_value ,
                           zval **return_value_ptr , zval *this_ptr ,
                           int return_value_used ) ;
static void zif_gc_enable(int ht , zval *return_value ,
                          zval **return_value_ptr , zval *this_ptr ,
                          int return_value_used ) ;
static void zif_gc_disable(int ht , zval *return_value ,
                           zval **return_value_ptr , zval *this_ptr ,
                           int return_value_used ) ;
static zend_arg_info const   arginfo_zend__void[1]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )-1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_func_get_arg[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"arg_num", sizeof("arg_num") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_strlen[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"str", sizeof("str") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_strcmp[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )2, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"str1", sizeof("str1") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"str2", sizeof("str2") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_strncmp[4]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )3, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"str1", sizeof("str1") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"str2", sizeof("str2") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"len", sizeof("len") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_each[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"arr", sizeof("arr") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )1}};
static zend_arg_info const   arginfo_error_reporting[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"new_error_level", sizeof("new_error_level") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_arg_info const   arginfo_define[4]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )3, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"constant_name", sizeof("constant_name") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}, 
        {"value", sizeof("value") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"case_insensitive", sizeof("case_insensitive") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_arg_info const   arginfo_defined[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"constant_name", sizeof("constant_name") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_arg_info const   arginfo_get_class[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"object", sizeof("object") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_is_subclass_of[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )2, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"object", sizeof("object") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"class_name", sizeof("class_name") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_get_class_vars[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"class_name", sizeof("class_name") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_get_object_vars[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"obj", sizeof("obj") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_get_class_methods[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"class", sizeof("class") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_method_exists[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )2, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"object", sizeof("object") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"method", sizeof("method") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_property_exists[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )2, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"object_or_class", sizeof("object_or_class") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}, 
        {"property_name", sizeof("property_name") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_arg_info const   arginfo_class_exists[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"classname", sizeof("classname") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"autoload", sizeof("autoload") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_trait_exists[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"traitname", sizeof("traitname") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"autoload", sizeof("autoload") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_function_exists[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"function_name", sizeof("function_name") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_arg_info const   arginfo_class_alias[4]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )2, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"user_class_name", sizeof("user_class_name") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}, 
        {"alias_name", sizeof("alias_name") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"autoload", sizeof("autoload") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_trigger_error[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"message", sizeof("message") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"error_type", sizeof("error_type") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_set_error_handler[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"error_handler", sizeof("error_handler") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}, 
        {"error_types", sizeof("error_types") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_set_exception_handler[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"exception_handler", sizeof("exception_handler") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_arg_info const   arginfo_create_function[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )2, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"args", sizeof("args") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"code", sizeof("code") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_get_resource_type[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"res", sizeof("res") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_get_loaded_extensions[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"zend_extensions", sizeof("zend_extensions") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_arg_info const   arginfo_get_defined_constants[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"categorize", sizeof("categorize") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_debug_backtrace[3]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"options", sizeof("options") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"limit", sizeof("limit") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_debug_print_backtrace[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"options", sizeof("options") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_extension_loaded[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )1, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"extension_name", sizeof("extension_name") - 1U,
      (char const   *)((void *)0), (zend_uint )0, (zend_uchar )0, (zend_bool )0,
      (zend_bool )0}};
static zend_function_entry const   builtin_functions[54]  = 
  {      {"zend_version", & zif_zend_version, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"func_num_args", & zif_func_num_args, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"func_get_arg", & zif_func_get_arg, arginfo_func_get_arg,
      sizeof(arginfo_func_get_arg) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"func_get_args", & zif_func_get_args, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"strlen", & zif_strlen, arginfo_strlen,
      sizeof(arginfo_strlen) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"strcmp", & zif_strcmp, arginfo_strcmp,
      sizeof(arginfo_strcmp) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"strncmp", & zif_strncmp, arginfo_strncmp,
      sizeof(arginfo_strncmp) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"strcasecmp", & zif_strcasecmp, arginfo_strcmp,
      sizeof(arginfo_strcmp) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"strncasecmp", & zif_strncasecmp, arginfo_strncmp,
      sizeof(arginfo_strncmp) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"each", & zif_each, arginfo_each,
      sizeof(arginfo_each) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )0}, 
        {"error_reporting", & zif_error_reporting, arginfo_error_reporting,
      sizeof(arginfo_error_reporting) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"define", & zif_define, arginfo_define,
      sizeof(arginfo_define) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"defined", & zif_defined, arginfo_defined,
      sizeof(arginfo_defined) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_class", & zif_get_class, arginfo_get_class,
      sizeof(arginfo_get_class) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_called_class", & zif_get_called_class, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_parent_class", & zif_get_parent_class, arginfo_get_class,
      sizeof(arginfo_get_class) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"method_exists", & zif_method_exists, arginfo_method_exists,
      sizeof(arginfo_method_exists) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"property_exists", & zif_property_exists, arginfo_property_exists,
      sizeof(arginfo_property_exists) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"class_exists", & zif_class_exists, arginfo_class_exists,
      sizeof(arginfo_class_exists) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"interface_exists", & zif_interface_exists, arginfo_class_exists,
      sizeof(arginfo_class_exists) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"trait_exists", & zif_trait_exists, arginfo_trait_exists,
      sizeof(arginfo_trait_exists) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"function_exists", & zif_function_exists, arginfo_function_exists,
      sizeof(arginfo_function_exists) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"class_alias", & zif_class_alias, arginfo_class_alias,
      sizeof(arginfo_class_alias) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_included_files", & zif_get_included_files, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_required_files", & zif_get_included_files, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"is_subclass_of", & zif_is_subclass_of, arginfo_is_subclass_of,
      sizeof(arginfo_is_subclass_of) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"is_a", & zif_is_a, arginfo_is_subclass_of,
      sizeof(arginfo_is_subclass_of) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_class_vars", & zif_get_class_vars, arginfo_get_class_vars,
      sizeof(arginfo_get_class_vars) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_object_vars", & zif_get_object_vars, arginfo_get_object_vars,
      sizeof(arginfo_get_object_vars) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_class_methods", & zif_get_class_methods, arginfo_get_class_methods,
      sizeof(arginfo_get_class_methods) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"trigger_error", & zif_trigger_error, arginfo_trigger_error,
      sizeof(arginfo_trigger_error) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"user_error", & zif_trigger_error, arginfo_trigger_error,
      sizeof(arginfo_trigger_error) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"set_error_handler", & zif_set_error_handler, arginfo_set_error_handler,
      sizeof(arginfo_set_error_handler) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"restore_error_handler", & zif_restore_error_handler, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"set_exception_handler", & zif_set_exception_handler,
      arginfo_set_exception_handler,
      sizeof(arginfo_set_exception_handler) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"restore_exception_handler", & zif_restore_exception_handler,
      arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_declared_classes", & zif_get_declared_classes, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_declared_traits", & zif_get_declared_traits, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_declared_interfaces", & zif_get_declared_interfaces,
      arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_defined_functions", & zif_get_defined_functions, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_defined_vars", & zif_get_defined_vars, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"create_function", & zif_create_function, arginfo_create_function,
      sizeof(arginfo_create_function) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_resource_type", & zif_get_resource_type, arginfo_get_resource_type,
      sizeof(arginfo_get_resource_type) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_loaded_extensions", & zif_get_loaded_extensions,
      arginfo_get_loaded_extensions,
      sizeof(arginfo_get_loaded_extensions) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"extension_loaded", & zif_extension_loaded, arginfo_extension_loaded,
      sizeof(arginfo_extension_loaded) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_extension_funcs", & zif_get_extension_funcs,
      arginfo_extension_loaded,
      sizeof(arginfo_extension_loaded) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"get_defined_constants", & zif_get_defined_constants,
      arginfo_get_defined_constants,
      sizeof(arginfo_get_defined_constants) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"debug_backtrace", & zif_debug_backtrace, arginfo_debug_backtrace,
      sizeof(arginfo_debug_backtrace) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"debug_print_backtrace", & zif_debug_print_backtrace,
      arginfo_debug_print_backtrace,
      sizeof(arginfo_debug_print_backtrace) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"gc_collect_cycles", & zif_gc_collect_cycles, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"gc_enabled", & zif_gc_enabled, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"gc_enable", & zif_gc_enable, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {"gc_disable", & zif_gc_disable, arginfo_zend__void,
      sizeof(arginfo_zend__void) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )0}, 
        {(char const   *)((void *)0),
...
{ 
  ...
  class_entry.name_length = (zend_uint )_len;
  ...
  class_entry.serialize = (int (*)(zval *object , unsigned char **buffer ,
                                   zend_uint *buf_len ,
                                   zend_serialize_data *data ))((void *)0);
  class_entry.unserialize = (int (*)(zval **object , zend_class_entry *ce ,
                                     unsigned char const   *buf ,
                                     zend_uint buf_len ,
                                     zend_unserialize_data *data ))((void *)0);
  class_entry.create_object = (zend_object_value (*)(zend_class_entry *class_type ))((void *)0);
  class_entry.interface_gets_implemented = (int (*)(zend_class_entry *iface ,
                                                    zend_class_entry *class_type ))((void *)0);
  class_entry.get_static_method = (union _zend_function *(*)(zend_class_entry *ce ,
                                                             char *method ,
  ...
  class_entry.num_interfaces = (zend_uint )0;
  class_entry.traits = (zend_class_entry **)((void *)0);
  class_entry.num_traits = (zend_uint )0;
  ...
  class_entry.get_iterator = (zend_object_iterator *(*)(zend_class_entry *ce ,
                                                        zval *object ,
                                                        int by_ref ))((void *)0);
...
zend_module_entry zend_builtin_module  = 
    ...
    (struct _zend_module_dep  const  *)((void *)0), "Core", builtin_functions,
    & zm_startup_core, (int (*)(int type , int module_number ))((void *)0),
    (int (*)(int type , int module_number ))((void *)0),
    (int (*)(int type , int module_number ))((void *)0),
    (void (*)(zend_module_entry *zend_module ))((void *)0), "2.4.0", (size_t )0,
    (void *)0, (void (*)(void *global ))((void *)0),
    (void (*)(void *global ))((void *)0), (int (*)(void))((void *)0), 0,
...
{ 
  ...
  {
  zend_alter_ini_entry((char *)"zend.enable_gc", sizeof("zend.enable_gc"),
                       (char *)"1", sizeof("1") - 1U, 1, 1 << 4);
  return;
}
}
static void zif_gc_disable(int ht , zval *return_value ,
...
{ 
  ...
  if (ex) {
    if (ex->function_state.arguments) {
      __z = return_value;
      __z->value.lval = (long )((zend_uintptr_t )*(ex->function_state.arguments));
      __z->type = (zend_uchar )1;
      return;
    } else {
      zend_error(1 << 1L,
...
{ 
  ...
  *return_value = *arg;
  ...
  return_value->refcount__gc = (zend_uint )1;
  return_value->is_ref__gc = (zend_uchar )0;
  return;
}
}
static void zif_func_get_args(int ht , zval *return_value ,
...
{ 
  ...
  p = ex->function_state.arguments;
  arg_count = (int )((zend_uintptr_t )*p);
  _array_init(return_value, (uint )arg_count);
  i = 0;
  while (i < arg_count) {
    while (1) {
    ...
    *element = *(*((zval **)(p - (arg_count - i))));
    ...
    element->refcount__gc = (zend_uint )1;
    element->is_ref__gc = (zend_uchar )0;
...
{ 
  ...
  __z = return_value;
  tmp___0 = zend_binary_strcmp((char const   *)s1, (uint )s1_len,
                               (char const   *)s2, (uint )s2_len);
...
{ 
  ...
  __z___0 = return_value;
  tmp___0 = zend_binary_strncmp((char const   *)s1, (uint )s1_len,
                                (char const   *)s2, (uint )s2_len, (uint )len);
...
{ 
  ...
  __z = return_value;
  tmp___0 = zend_binary_strcasecmp((char const   *)s1, (uint )s1_len,
                                   (char const   *)s2, (uint )s2_len);
  __z->value.lval = (long )tmp___0;
  __z->type = (zend_uchar )1;
  return;
...
{ 
  ...
  __z___0 = return_value;
  tmp___0 = zend_binary_strncasecmp((char const   *)s1, (uint )s1_len,
                                    (char const   *)s2, (uint )s2_len,
                                    (uint )len);
  __z___0->value.lval = (long )tmp___0;
  __z___0->type = (zend_uchar )1;
...
{ 
  ...
  tmp___3 = zend_hash_get_current_data_ex(target_hash, (void **)(& entry_ptr),
                                          (HashPosition *)((void *)0));
  ...
  if (tmp___5) {
    ...
    *tmp = *entry;
    ...
    zval_set_refcount_p(tmp, (zend_uint )0);
    entry = tmp;
  } else {

  }
  _zend_hash_index_update_or_next_insert(return_value->value.ht, (ulong )1,
                                         (void *)(& entry), sizeof(zval *),
                                         (void **)((void *)0), 1);
  zval_addref_p(entry);
  _zend_hash_add_or_update(return_value->value.ht, "value", sizeof("value"),
                           (void *)(& entry), sizeof(zval *),
                           (void **)((void *)0), 1);
  zval_addref_p(entry);
  tmp___6 = zend_hash_get_current_key_ex((HashTable const   *)target_hash,
                                         & string_key, & string_key_len,
                                         & num_key, (zend_bool )1,
                                         (HashPosition *)((void *)0));
  switch (tmp___6) {
  case (int __attribute__((__visibility__("default")))  )1: 
  add_get_index_stringl(return_value, (ulong )0, (char const   *)string_key,
                        string_key_len - 1U, (void **)(& inserted_pointer), 0);
  break;
  case (int __attribute__((__visibility__("default")))  )2: 
  add_get_index_long(return_value, (ulong )0, (long )num_key,
                     (void **)(& inserted_pointer));
  break;
  }
  _zend_hash_add_or_update(return_value->value.ht, "key", sizeof("key"),
                           (void *)inserted_pointer, sizeof(zval *),
                           (void **)((void *)0), 1);
...
{ 
  ...
  if (ht != 0) {
    zend_alter_ini_entry((char *)"error_reporting", sizeof("error_reporting"),
                         err, (uint )err_len, 1, 1 << 4);
  } else {
...
{ 
  ...
  tmp___0 = zend_memnstr(name, (char *)"::", (int )(sizeof("::") - 1U),
                         name + name_len);
  if (tmp___0) {
  ...
  if (! val_free) {
    ...
    if ((val->value.obj.handlers)->cast_object) {
      ...
      *val_free = (zval )zval_used_for_init;
...
{ 
  ...
  tmp___0 = zend_get_constant_ex((char const   *)name, (uint )name_len, & c,
                                 (zend_class_entry *)((void *)0), (ulong )256);
  if (tmp___0) {
    _zval_dtor(& c);
    while (1) {
      __z = return_value;
...
{ 
  ...
  if ((int )arg->type == 5) {
    if ((arg->value.obj.handlers)->get_class_name) {
      tmp___3 = (*((arg->value.obj.handlers)->get_class_name))((zval const   *)arg,
                                                               & name,
                                                               & name_length, 1);
      if (tmp___3 == 0) {
        while (1) {
  ...
  if ((int )arg->type == 6) {
    tmp___4 = zend_lookup_class((char const   *)arg->value.str.val,
                                arg->value.str.len, & pce);
    if (tmp___4 == (int __attribute__((__visibility__("default")))  )0) {
      ce = *pce;
    } else {
...
static void is_a_impl(int ht , zval *return_value , zval **return_value_ptr ,
                      zval *this_ptr , int return_value_used ,
...
{ 
  ...
  if ((int )obj->type == 6) {
    tmp___0 = zend_lookup_class((char const   *)obj->value.str.val,
                                obj->value.str.len, & the_ce);
    if (tmp___0 == (int __attribute__((__visibility__("default")))  )-1) {
      while (1) {
        __z = return_value;
        __z->value.lval = 0L;
  ...
  tmp___3 = zend_lookup_class_ex((char const   *)class_name, class_name_len,
                                 (zend_literal const   *)((void *)0), 0, & ce);
  if (tmp___3 == (int __attribute__((__visibility__("default")))  )-1) {
    retval = (zend_bool )0;
  } else
  if (only_subclass) {
    if ((unsigned int )instance_ce == (unsigned int )*ce) {
      ...
      tmp___2 = instanceof_function((zend_class_entry const   *)instance_ce,
                                    (zend_class_entry const   *)*ce);
      retval = (zend_bool )tmp___2;
    }
  } else {
    tmp___2 = instanceof_function((zend_class_entry const   *)instance_ce,
                                  (zend_class_entry const   *)*ce);
...
{ 
  ...
  {
  is_a_impl(ht, return_value, return_value_ptr, this_ptr, return_value_used,
            (zend_bool )1);
  return;
}
}
...
{ 
  ...
  while (1) {
    tmp___2 = zend_hash_get_current_data_ex(& ce->properties_info,
                                            (void **)(& prop_info), & pos);
    ...
    zend_hash_get_current_key_ex((HashTable const   *)(& ce->properties_info),
                                 & key, & key_len, & num_index, (zend_bool )0,
                                 & pos);
    ...
    *prop_copy = *prop;
    ...
    prop_copy->refcount__gc = (zend_uint )1;
    prop_copy->is_ref__gc = (zend_uchar )0;
    if ((int )prop_copy->type == 9) {
      zval_update_constant(& prop_copy, (void *)0);
    } else
    if (((int )prop_copy->type & 15) == 8) {
      zval_update_constant(& prop_copy, (void *)0);
    } else {
...
{ 
  ...
  while (1) {
    tmp___4 = zend_hash_get_current_data_ex(properties, (void **)(& value),
                                            & pos);
    if (tmp___4 == (int __attribute__((__visibility__("default")))  )0) {
    ...
    tmp___3 = zend_hash_get_current_key_ex((HashTable const   *)properties,
                                           & key, & key_len, & num_index,
                                           (zend_bool )0, & pos);
    if (tmp___3 == (int __attribute__((__visibility__("default")))  )1) {
      tmp___2 = zend_check_property_access(zobj, (char const   *)key,
                                           (int )(key_len - 1U));
      if (tmp___2 == (int __attribute__((__visibility__("default")))  )0) {
        zend_unmangle_property_name((char const   *)key, (int )(key_len - 1U),
          ...
          if ((unsigned int )mptr->common.scope == (unsigned int )ce) {
            ...
            if (tmp___5 != (int __attribute__((__visibility__("default")))  )1) {
              ...
              if (tmp___6 == (int __attribute__((__visibility__("default")))  )0) {
                ...
                method_name->refcount__gc = (zend_uint )1;
                method_name->is_ref__gc = (zend_uchar )0;
                while (1) {
...
{ 
  ...
  tmp___2 = zend_str_tolower_dup((char const   *)method_name,
                                 (unsigned int )method_len);
  lcname = (char *)tmp___2;
  tmp___6 = zend_hash_exists((HashTable const   *)(& ce->function_table),
                             (char const   *)lcname, (uint )(method_len + 1));
  if (tmp___6) {
    _efree((void *)lcname);
    while (1) {
      __z___1 = return_value;
    ...
    if ((int )klass->type == 5) {
      if ((unsigned int )(klass->value.obj.handlers)->get_method != (unsigned int )((void *)0)) {
        func = (*((klass->value.obj.handlers)->get_method))(& klass,
                                                            method_name,
                                                            method_len,
              ...
              while (1) {
                ...
                if ((unsigned int )func->common.scope == (unsigned int )zend_ce_closure) {
                  if ((unsigned int )method_len == sizeof("__invoke") - 1U) {
                    tmp___5 = memcmp((void const   *)lcname,
                                     (void const   *)"__invoke",
                                     sizeof("__invoke") - 1U);
                    if (tmp___5 == 0) {
                      tmp___4 = 1;
...
{ 
  ...
  if ((int )object->type == 6) {
    tmp___0 = zend_lookup_class((char const   *)object->value.str.val,
                                object->value.str.len, & pce);
    if (tmp___0 == (int __attribute__((__visibility__("default")))  )-1) {
      while (1) {
        __z___0 = return_value;
        __z___0->value.lval = 0L;
  ...
  tmp___2 = zend_get_hash_value((char const   *)property,
                                (uint )(property_len + 1));
  h = (ulong )tmp___2;
  tmp___3 = zend_hash_quick_find((HashTable const   *)(& ce->properties_info),
                                 (char const   *)property,
                                 (uint )(property_len + 1), h,
                                 (void **)(& property_info));
  ...
  if ((int )object->type == 5) {
    if ((object->value.obj.handlers)->has_property) {
      tmp___5 = (*((object->value.obj.handlers)->has_property))(object,
                                                                & property_z, 2,
                                                                (struct _zend_literal  const  *)0);
      if (tmp___5) {
        while (1) {
          __z___3 = return_value;
          __z___3->value.lval = 1L;
...
{ 
  ...
  tmp = zend_parse_parameters(ht, "s|b", & class_name, & class_name_len,
                              & autoload);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    return;
  } else {
  ...
  if (! autoload) {
    ...
    use_heap = (zend_bool )tmp___3;
    if (use_heap) {
      tmp___1 = _emalloc((size_t )(class_name_len + 1));
      lc_name = (char *)tmp___1;
    } else {
      tmp___2 = __builtin_alloca((unsigned int )(class_name_len + 1));
      lc_name = (char *)tmp___2;
    }
    zend_str_tolower_copy(lc_name, (char const   *)class_name,
    ...
    tmp___4 = zend_hash_find((HashTable const   *)executor_globals.class_table,
                             (char const   *)name, (uint )(len + 1),
                             (void **)(& ce));
    found = (int )tmp___4;
    while (1) {
...
{ 
  ...
  {
  autoload = (zend_bool )1;
  tmp = zend_parse_parameters(ht, "s|b", & iface_name, & iface_name_len,
                              & autoload);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    return;
  } else {
  ...
  if (! autoload) {
    ...
    use_heap = (zend_bool )tmp___3;
    if (use_heap) {
      tmp___1 = _emalloc((size_t )(iface_name_len + 1));
      lc_name = (char *)tmp___1;
    } else {
      tmp___2 = __builtin_alloca((unsigned int )(iface_name_len + 1));
      lc_name = (char *)tmp___2;
    }
    zend_str_tolower_copy(lc_name, (char const   *)iface_name,
                          (unsigned int )iface_name_len);
    name = lc_name;
    len = iface_name_len;
    if ((int )*(lc_name + 0) == 92) {
      name = lc_name + 1;
...
{ 
  ...
  {
  autoload = (zend_bool )1;
  tmp = zend_parse_parameters(ht, "s|b", & trait_name, & trait_name_len,
                              & autoload);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    return;
  } else {
  ...
  if (! autoload) {
    ...
    use_heap = (zend_bool )tmp___3;
    if (use_heap) {
      tmp___1 = _emalloc((size_t )(trait_name_len + 1));
      lc_name = (char *)tmp___1;
    } else {
      tmp___2 = __builtin_alloca((unsigned int )(trait_name_len + 1));
      lc_name = (char *)tmp___2;
    }
    zend_str_tolower_copy(lc_name, (char const   *)trait_name,
                          (unsigned int )trait_name_len);
    name = lc_name;
    len = trait_name_len;
    if ((int )*(lc_name + 0) == 92) {
      name = lc_name + 1;
...
{ 
  ...
  tmp___1 = zend_hash_find((HashTable const   *)executor_globals.function_table,
                           ...
                           (void **)(& func));
  retval = (zend_bool )(tmp___1 == (int __attribute__((__visibility__("default")))  )0);
  _efree((void *)lcname);
  if (retval) {
    if ((int )func->type == 1) {
...
{ 
  ...
  {
  autoload = (zend_bool )1;
  tmp = zend_parse_parameters(ht, "ss|b", & class_name, & class_name_len,
                              & alias_name, & alias_name_len, & autoload);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    return;
  } else {
  ...
  if (found == 0) {
    if ((int )(*ce)->type == 2) {
      tmp___7 = zend_register_class_alias_ex((char const   *)alias_name,
                                             alias_name_len, *ce);
      if (tmp___7 == (int __attribute__((__visibility__("default")))  )0) {
        while (1) {
          __z = return_value;
...
{ 
  ...
  _array_init(return_value, (uint )0);
  zend_hash_internal_pointer_reset_ex(& executor_globals.included_files,
                                      (HashPosition *)((void *)0));
  while (1) {
    tmp___0 = zend_hash_get_current_key_ex((HashTable const   *)(& executor_globals.included_files),
                                           & entry, (uint *)((void *)0),
                                           (ulong *)((void *)0), (zend_bool )1,
                                           (HashPosition *)((void *)0));
    if (tmp___0 == (int __attribute__((__visibility__("default")))  )1) {
    ...
    zend_hash_move_forward_ex(& executor_globals.included_files,
                              (HashPosition *)((void *)0));
  }
  return;
}
...
{ 
  ...
  tmp___2 = zend_is_callable(error_handler, (uint )0, & error_handler_name);
  if (tmp___2) {
  ...
  if (executor_globals.user_error_handler) {
    had_orig_error_handler = (zend_bool )1;
    *return_value = *(executor_globals.user_error_handler);
    _zval_copy_ctor(return_value);
    return_value->refcount__gc = (zend_uint )1;
    return_value->is_ref__gc = (zend_uchar )0;
    zend_stack_push(& executor_globals.user_error_handlers_error_reporting,
                    (void const   *)(& executor_globals.user_error_handler_error_reporting),
                    (int )sizeof(executor_globals.user_error_handler_error_reporting));
    zend_ptr_stack_push(& executor_globals.user_error_handlers,
                        (void *)executor_globals.user_error_handler);
  } else {
  ...
  if (tmp___4) {
    ...
    while (1) {
      if ((gc_root_buffer *)((zend_uintptr_t )((zval_gc_info *)executor_globals.user_error_handler)->u.buffered & 4294967292UL)) {
  ...
  *(executor_globals.user_error_handler) = *error_handler;
  ...
  (executor_globals.user_error_handler)->refcount__gc = (zend_uint )1;
  (executor_globals.user_error_handler)->is_ref__gc = (zend_uchar )0;
...
{ 
  ...
  if ((int )exception_handler->type != 0) {
    tmp___2 = zend_is_callable(exception_handler, (uint )0,
  ...
  if (executor_globals.user_exception_handler) {
    had_orig_exception_handler = (zend_bool )1;
    *return_value = *(executor_globals.user_exception_handler);
    _zval_copy_ctor(return_value);
    zend_ptr_stack_push(& executor_globals.user_exception_handlers,
                        (void *)executor_globals.user_exception_handler);
  } else {
  ...
  if ((int )exception_handler->type == 0) {
    while (1) {
      if ((gc_root_buffer *)((zend_uintptr_t )((zval_gc_info *)executor_globals.user_exception_handler)->u.buffered & 4294967292UL)) {
...
{ 
  ...
  array = tmp___0;
  tmp___2 = __builtin_va_arg(args, zend_uint );
  mask = tmp___2;
  tmp___4 = __builtin_va_arg(args, zend_uint );
  comply = tmp___4;
  if (comply) {
    tmp___5 = mask;
  } else {
...
{ 
  ...
  _array_init(return_value, (uint )0);
  zend_hash_apply_with_arguments(executor_globals.class_table,
                                 (int (*)(void *pDest , int num_args ,
                                          va_list args ,
                                          zend_hash_key *hash_key ))(& copy_class_or_interface_name),
                                 3, return_value, mask, comply);
  return;
}
}
static void zif_get_declared_classes(int ht , zval *return_value ,
...
static int copy_function_name(zend_function *func , int num_args ,
                              va_list args , zend_hash_key *hash_key ) 
{ 
  zval *internal_ar ;
  zval *tmp ;
  ...
  tmp___0 = __builtin_va_arg(args, zval *);
  internal_ar = tmp___0;
  tmp___2 = __builtin_va_arg(args, zval *);
  user_ar = tmp___2;
  if (hash_key->nKeyLength == 0U) {
    return (0);
  } else
  ...
  if ((int )func->type == 1) {
    add_next_index_stringl(internal_ar, hash_key->arKey,
                           hash_key->nKeyLength - 1U, 1);
  } else
  if ((int )func->type == 2) {
    add_next_index_stringl(user_ar, hash_key->arKey, hash_key->nKeyLength - 1U,
                           1);
  } else {
...
{ 
  ...
  internal->refcount__gc = (zend_uint )1;
  internal->is_ref__gc = (zend_uchar )0;
  while (1) {
    tmp___1 = _emalloc(sizeof(zval_gc_info ));
    user = (zval *)tmp___1;
  ...
  user->refcount__gc = (zend_uint )1;
  user->is_ref__gc = (zend_uchar )0;
  _array_init(internal, (uint )0);
  _array_init(user, (uint )0);
  _array_init(return_value, (uint )0);
  zend_hash_apply_with_arguments(executor_globals.function_table,
                                 (int (*)(void *pDest , int num_args ,
                                          va_list args ,
                                          zend_hash_key *hash_key ))(& copy_function_name),
                                 2, internal, user);
  tmp___2 = _zend_hash_add_or_update(return_value->value.ht, "internal",
                                     sizeof("internal"),
                                     (void *)((void **)(& internal)),
  ...
  tmp___3 = _zend_hash_add_or_update(return_value->value.ht, "user",
                                     sizeof("user"),
                                     (void *)((void **)(& user)),
                                     sizeof(zval *), (void **)((void *)0),
                                     1 << 1);
...
{ 
  ...
  _array_init(return_value, (uint )tmp);
...
{ 
  ...
  {
  {
  tmp = zend_parse_parameters(ht, "ss", & function_args, & function_args_len,
                              & function_code, & function_code_len);
  ...
  memcpy((void */* __restrict  */)eval_code,
         (void const   */* __restrict  */)"function __lambda_func(",
         (size_t )eval_code_length);
  memcpy((void */* __restrict  */)(eval_code + eval_code_length),
         (void const   */* __restrict  */)function_args,
  ...
  *(eval_code + tmp___2) = (char )'{';
  memcpy((void */* __restrict  */)(eval_code + eval_code_length),
         (void const   */* __restrict  */)function_code,
         (size_t )function_code_len);
  ...
  *(eval_code + eval_code_length) = (char )'\000';
  ...
  tmp___5 = zend_eval_stringl(eval_code, eval_code_length, (zval *)((void *)0),
                              eval_name);
  retval = (int )tmp___5;
  _efree((void *)eval_code);
  _efree((void *)eval_name);
  if (retval == 0) {
    tmp___6 = zend_hash_find((HashTable const   *)executor_globals.function_table,
                             "__lambda_func", sizeof("__lambda_func"),
                             (void **)(& func));
    ...
    *(function_name + 0) = (char )'\000';
    while (1) {
      ...
      tmp___8 = snprintf((char */* __restrict  */)(function_name + 1),
                         sizeof("lambda_") + 11U,
                         (char const   */* __restrict  */)"lambda_%d",
                         executor_globals.lambda_count);
      function_name_length = 1 + tmp___8;
      tmp___9 = _zend_hash_add_or_update(executor_globals.function_table,
                                         (char const   *)function_name,
                                         (uint )(function_name_length + 1),
                                         (void *)(& new_function),
    ...
    zend_hash_del_key_or_index(executor_globals.function_table, "__lambda_func",
                               sizeof("__lambda_func"), (ulong )0, 0);
    while (1) {
...
{ 
  ...
  const_val->refcount__gc = (zend_uint )1;
  const_val->is_ref__gc = (zend_uchar )0;
  *const_val = constant->value;
  _zval_copy_ctor(const_val);
  const_val->refcount__gc = (zend_uint )1;
  const_val->is_ref__gc = (zend_uchar )0;
  add_assoc_zval_ex(name_array, (char const   *)constant->name,
                    constant->name_len, const_val);
  return (0);
}
}
static void zif_get_loaded_extensions(int ht , zval *return_value ,
...
{ 
  ...
  _array_init(return_value, (uint )0);
  if (zendext) {
    zend_llist_apply_with_argument((zend_llist *)(& zend_extensions),
                                   (void (*)(void *data , void *arg ))(& add_zendext_info),
                                   (void *)return_value);
  } else {
    zend_hash_apply_with_argument((HashTable *)(& module_registry),
                                  (int (*)(void *pDest , void *argument ))(& add_extension_info),
                                  (void *)return_value);
  }
  return;
}
...
{ 
  ...
  if (categorize) {
    ...
    tmp___1 = _ecalloc((size_t )(tmp___0 + (int __attribute__((__visibility__("default")))  )2),
                       sizeof(zval *));
    ...
    *(module_names + i) = (char *)"user";
    ...
    while (1) {
      ...
      if (! *(modules + module_number)) {
        ...
        (*(modules + module_number))->refcount__gc = (zend_uint )1;
        (*(modules + module_number))->is_ref__gc = (zend_uchar )0;
        _array_init(*(modules + module_number), (uint )0);
...
{ 
  ...
  arg_array->refcount__gc = (zend_uint )1;
  arg_array->is_ref__gc = (zend_uchar )0;
  _array_init(arg_array, (uint )arg_count);
  p -= arg_count;
  while (1) {
    arg_count --;
    if (arg_count >= 0) {
...
{ 
  ...
  while (1) {
    tmp___2 = zend_hash_get_current_data_ex(arg_array->value.ht,
                                            (void **)(& tmp), & iterator);
    if (tmp___2 == (int __attribute__((__visibility__("default")))  )0) {
    ...
    if (function_name) {
      if (ptr->object) {
        if ((ptr->function_state.function)->common.scope) {
          ...
          tmp___0 = zend_get_object_classname((zval const   *)ptr->object,
      ...
      if (! ptr->opline) {
        ...
        build_filename_arg = (zend_bool )0;
      } else
      ...
      if (build_filename_arg) {
        if (include_filename) {
          ...
          arg_array->refcount__gc = (zend_uint )1;
          arg_array->is_ref__gc = (zend_uchar )0;
          _array_init(arg_array, (uint )0);
          add_next_index_string(arg_array,
                                (char const   *)((char *)include_filename), 1);
        } else {
...
{ 
  ...
  while (1) {
    ...
    stack_frame->refcount__gc = (zend_uint )1;
    stack_frame->is_ref__gc = (zend_uchar )0;
    _array_init(stack_frame, (uint )0);
    skip = ptr;
    if (! skip->op_array) {
      if (skip->prev_execute_data) {
        if ((skip->prev_execute_data)->opline) {
    ...
    if (skip->op_array) {
      filename = (skip->op_array)->filename;
      lineno = (int )(skip->opline)->lineno;
      add_assoc_string_ex(stack_frame, "file", sizeof("file"), (char *)filename,
                          1);
      ...
      while (prev) {
        ...
        if (prev->op_array) {
          add_assoc_string_ex(stack_frame, "file", sizeof("file"),
                              (char *)(prev->op_array)->filename, 1);
          add_assoc_long_ex(stack_frame, "line", sizeof("line"),
                            (long )(prev->opline)->lineno);
          break;
        } else {
    ...
    function_name = (ptr->function_state.function)->common.function_name;
    if (function_name) {
      add_assoc_string_ex(stack_frame, "function", sizeof("function"),
                          (char *)function_name, 1);
      if (ptr->object) {
        if ((int )(ptr->object)->type == 5) {
          if ((ptr->function_state.function)->common.scope) {
            add_assoc_string_ex(stack_frame, "class", sizeof("class"),
                                (char *)((ptr->function_state.function)->common.scope)->name,
                                1);
          } else {
            tmp___1 = zend_get_object_classname((zval const   *)ptr->object,
                                                & class_name, & class_name_len);
            dup = (int )tmp___1;
            add_assoc_string_ex(stack_frame, "class", sizeof("class"),
                                (char *)class_name, dup);
          ...
          if ((options & 1) != 0) {
            add_assoc_zval_ex(stack_frame, "object", sizeof("object"),
                              ptr->object);
            zval_addref_p(ptr->object);
          } else {

          }
          add_assoc_string_ex(stack_frame, "type", sizeof("type"), (char *)"->",
                              1);
        } else {
          goto _L;
        }
...
{ 
  ...
  tmp___0 = zend_str_tolower_dup((char const   *)extension_name,
                                 (unsigned int )extension_name_len);
  lcname = (char *)tmp___0;
  tmp___1 = zend_hash_exists((HashTable const   *)(& module_registry),
                             (char const   *)lcname,
                             (uint )(extension_name_len + 1));
  if (tmp___1) {
    while (1) {
      __z = return_value;
      __z->value.lval = 1L;
...
{ 
  ...
  if (tmp___2) {
    tmp___0 = zend_str_tolower_dup((char const   *)extension_name,
                                   (unsigned int )extension_name_len);
    lcname = (char *)tmp___0;
    tmp___1 = zend_hash_find((HashTable const   *)(& module_registry),
                             (char const   *)lcname,
                             (uint )(extension_name_len + 1),
                             (void **)(& module));
    if (tmp___1 == (int __attribute__((__visibility__("default")))  )-1) {
