...
extern void __attribute__((__visibility__("default")))  zend_fetch_debug_backtrace(zval *return_value ,
                                                                                   int skip_last ,
                                                                                   int options ) ;
...
extern int __attribute__((__visibility__("default")))  zend_class_unserialize_deny(zval **object ,
                                                                                   ...
                                                                                   zend_uint buf_len ,
                                                                                   zend_unserialize_data *data ) ;
void __attribute__((__visibility__("default")))  zend_exception_set_previous(zval *exception ,
                                                                             zval *add_previous ) ;
...
zval __attribute__((__visibility__("default")))  *zend_throw_exception(zend_class_entry *exception_ce ,
                                                                       char *message ,
                                                                       long code ) ;
zval __attribute__((__visibility__("default")))  *zend_throw_exception_ex(zend_class_entry *exception_ce ,
                                                                          long code ,
                                                                          char *format 
                                                                          , ...) ;
...
zval __attribute__((__visibility__("default")))  *zend_throw_error_exception(zend_class_entry *exception_ce ,
                                                                             char *message ,
                                                                             long code ,
                                                                             int severity ) ;
void __attribute__((__visibility__("default")))  (*zend_throw_exception_hook)(zval *ex )  ;
void __attribute__((__visibility__("default")))  zend_exception_error(zval *exception ,
                                                                      int severity ) ;
...
{ 
  ...
  if ((int )add_previous->type != 5) {
    ...
    tmp___0 = instanceof_function((zend_class_entry const   *)tmp,
                                  (zend_class_entry const   *)default_exception_ce);
    if (tmp___0) {
  ...
  while (1) {
    ...
    tmp___1 = zend_read_property(default_exception_ce, exception,
                                 (char *)"previous",
                                 (int )(sizeof("previous") - 1U), (zend_bool )1);
    previous = (zval *)tmp___1;
    if ((int )previous->type == 0) {
      zend_update_property(default_exception_ce, exception, (char *)"previous",
                           (int )(sizeof("previous") - 1U), add_previous);
...
{ 
  ...
  if (executor_globals.prev_exception) {
    zend_exception_set_previous(executor_globals.exception,
...
static zend_object_value zend_default_exception_new_ex(zend_class_entry *class_type ,
                                                       int skip_top_traces ) 
{ 
  zval obj ;
  zend_object *object ;
  ...
  obj.value.obj = (zend_object_value )tmp;
  ...
  zval_set_refcount_p(trace, (zend_uint )0);
  zend_fetch_debug_backtrace(trace, skip_top_traces, 0);
  tmp___1 = zend_get_executed_filename();
  zend_update_property_string(default_exception_ce, & obj, (char *)"file",
                              (int )(sizeof("file") - 1U),
                              (char const   *)tmp___1);
  tmp___2 = zend_get_executed_lineno();
  zend_update_property_long(default_exception_ce, & obj, (char *)"line",
                            (int )(sizeof("line") - 1U), (long )tmp___2);
  zend_update_property(default_exception_ce, & obj, (char *)"trace",
                       (int )(sizeof("trace") - 1U), trace);
...
void zim_exception___clone(int ht , zval *return_value ,
                           zval **return_value_ptr , zval *this_ptr ,
                           int return_value_used ) 
{ 
  ...
  {
  zend_throw_exception((zend_class_entry *)((void *)0),
                       (char *)"Cannot clone object using __clone()", 0L);
  return;
}
}
void zim_exception___construct(int ht , zval *return_value ,
                               zval **return_value_ptr , zval *this_ptr ,
                               int return_value_used ) 
{ 
  char *message ;
  ...
  argc = ht;
  tmp = zend_parse_parameters_ex(1 << 1, argc, "|slO!", & message,
                                 & message_len, & code, & previous,
  ...
  object = this_ptr;
  if (message) {
    zend_update_property_string(default_exception_ce, object, (char *)"message",
  ...
  if (code) {
    zend_update_property_long(default_exception_ce, object, (char *)"code",
                              (int )(sizeof("code") - 1U), code);
  } else {

  }
  if (previous) {
    zend_update_property(default_exception_ce, object, (char *)"previous",
                         (int )(sizeof("previous") - 1U), previous);
  } else {
...
void zim_error_exception___construct(int ht , zval *return_value ,
                                     zval **return_value_ptr , zval *this_ptr ,
                                     int return_value_used ) 
{ 
  char *message ;
  ...
  previous = (zval *)((void *)0);
  argc = ht;
  tmp = zend_parse_parameters_ex(1 << 1, argc, "|sllslO!", & message,
                                 & message_len, & code, & severity, & filename,
                                 & filename_len, & lineno, & previous,
                                 default_exception_ce);
  if (tmp == (int __attribute__((__visibility__("default")))  )-1) {
    zend_error(1,
  ...
  zend_update_property_long(default_exception_ce, object, (char *)"severity",
                            (int )(sizeof("severity") - 1U), severity);
  if (argc >= 4) {
    zend_update_property_string(default_exception_ce, object, (char *)"file",
                                (int )(sizeof("file") - 1U),
                                (char const   *)filename);
    if (argc < 5) {
      lineno = 0L;
    ...
    zend_update_property_long(default_exception_ce, object, (char *)"line",
                              (int )(sizeof("line") - 1U), lineno);
  } else {
...
static void _default_exception_get_entry(zval *object , char *name ,
                                         int name_len , zval *return_value ) 
{ 
  zval *value ;
  zval __attribute__((__visibility__("default")))  *tmp ;

  {
  tmp = zend_read_property(default_exception_ce, object, name, name_len,
                           (zend_bool )0);
  value = (zval *)tmp;
  *return_value = *value;
...
void zim_exception_getFile(int ht , zval *return_value ,
                           zval **return_value_ptr , zval *this_ptr ,
                           int return_value_used ) 
{ 
  int __attribute__((__visibility__("default")))  tmp ;
  ...
  _default_exception_get_entry(this_ptr, (char *)"file",
                               (int )(sizeof("file") - 1U), return_value);
  return;
}
}
void zim_exception_getLine(int ht , zval *return_value ,
                           zval **return_value_ptr , zval *this_ptr ,
                           int return_value_used ) 
{ 
  int __attribute__((__visibility__("default")))  tmp ;
  ...
  _default_exception_get_entry(this_ptr, (char *)"line",
                               (int )(sizeof("line") - 1U), return_value);
  return;
}
}
void zim_exception_getMessage(int ht , zval *return_value ,
                              zval **return_value_ptr , zval *this_ptr ,
                              int return_value_used ) 
{ 
  int __attribute__((__visibility__("default")))  tmp ;
  ...
  _default_exception_get_entry(this_ptr, (char *)"message",
                               (int )(sizeof("message") - 1U), return_value);
  return;
}
}
void zim_exception_getCode(int ht , zval *return_value ,
                           zval **return_value_ptr , zval *this_ptr ,
                           int return_value_used ) 
{ 
  int __attribute__((__visibility__("default")))  tmp ;
  ...
  _default_exception_get_entry(this_ptr, (char *)"code",
                               (int )(sizeof("code") - 1U), return_value);
  return;
}
}
void zim_exception_getTrace(int ht , zval *return_value ,
                            zval **return_value_ptr , zval *this_ptr ,
                            int return_value_used ) 
{ 
  int __attribute__((__visibility__("default")))  tmp ;
  ...
  _default_exception_get_entry(this_ptr, (char *)"trace",
                               (int )(sizeof("trace") - 1U), return_value);
  return;
}
}
void zim_error_exception_getSeverity(int ht , zval *return_value ,
                                     zval **return_value_ptr , zval *this_ptr ,
                                     int return_value_used ) 
{ 
  int __attribute__((__visibility__("default")))  tmp ;
  ...
  _default_exception_get_entry(this_ptr, (char *)"severity",
                               (int )(sizeof("severity") - 1U), return_value);
  return;
}
}
...
{ 
  ...
  tmp___1 = _erealloc((void *)*str, (size_t )((*len + l) + 1), 0);
  *str = (char *)tmp___1;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)"NULL, ", (size_t )l);
  *len += l;
  break;
  case 6: 
  tmp___2 = _erealloc((void *)*str, (size_t )((*len + 1) + 1), 0);
  *str = (char *)tmp___2;
  tmp___3 = *len;
  (*len) ++;
  *(*str + tmp___3) = (char )'\'';
  if ((*arg)->value.str.len > 15) {
    l___0 = 15;
    tmp___4 = _erealloc((void *)*str, (size_t )((*len + l___0) + 1), 0);
    *str = (char *)tmp___4;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)(*arg)->value.str.val,
           (size_t )l___0);
    *len += l___0;
    l___1 = (int )(sizeof("...\', ") - 1U);
    tmp___5 = _erealloc((void *)*str, (size_t )((*len + l___1) + 1), 0);
    *str = (char *)tmp___5;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)"...\', ", (size_t )l___1);
    *len += l___1;
    l_added = 22;
  } else {
    l_added = (*arg)->value.str.len;
    l___2 = l_added;
    tmp___6 = _erealloc((void *)*str, (size_t )((*len + l___2) + 1), 0);
    *str = (char *)tmp___6;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)(*arg)->value.str.val,
           (size_t )l___2);
    *len += l___2;
    l___3 = (int )(sizeof("\', ") - 1U);
    tmp___7 = _erealloc((void *)*str, (size_t )((*len + l___3) + 1), 0);
    *str = (char *)tmp___7;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)"\', ", (size_t )l___3);
    *len += l___3;
    l_added += 4;
  }
  while (1) {
  ...
  if ((*arg)->value.lval) {
    ...
    tmp___8 = _erealloc((void *)*str, (size_t )((*len + l___4) + 1), 0);
    *str = (char *)tmp___8;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)"true, ", (size_t )l___4);
    *len += l___4;
  } else {
    l___5 = (int )(sizeof("false, ") - 1U);
    tmp___9 = _erealloc((void *)*str, (size_t )((*len + l___5) + 1), 0);
    *str = (char *)tmp___9;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)"false, ", (size_t )l___5);
    *len += l___5;
  }
  break;
  case 7: 
  l___6 = (int )(sizeof("Resource id #") - 1U);
  tmp___10 = _erealloc((void *)*str, (size_t )((*len + l___6) + 1), 0);
  *str = (char *)tmp___10;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)"Resource id #", (size_t )l___6);
  *len += l___6;
  case 1: 
  lval = (*arg)->value.lval;
  tmp___11 = sprintf((char */* __restrict  */)(s_tmp),
                     (char const   */* __restrict  */)"%ld", lval);
  l_tmp = tmp___11;
  l___7 = l_tmp;
  tmp___12 = _erealloc((void *)*str, (size_t )((*len + l___7) + 1), 0);
  *str = (char *)tmp___12;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)(s_tmp), (size_t )l___7);
  *len += l___7;
  l___8 = (int )(sizeof(", ") - 1U);
  tmp___13 = _erealloc((void *)*str, (size_t )((*len + l___8) + 1), 0);
  *str = (char *)tmp___13;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)", ", (size_t )l___8);
  *len += l___8;
  break;
  case 2: 
  dval = (*arg)->value.dval;
  tmp___14 = _emalloc((size_t )((32L + executor_globals.precision) + 1L));
  s_tmp___0 = (char *)tmp___14;
  l_tmp___0 = sprintf((char */* __restrict  */)s_tmp___0,
                      (char const   */* __restrict  */)"%.*G",
                      (int )executor_globals.precision, dval);
  l___9 = l_tmp___0;
  tmp___15 = _erealloc((void *)*str, (size_t )((*len + l___9) + 1), 0);
  *str = (char *)tmp___15;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)s_tmp___0, (size_t )l___9);
  *len += l___9;
  _efree((void *)s_tmp___0);
  l___10 = (int )(sizeof(", ") - 1U);
  tmp___16 = _erealloc((void *)*str, (size_t )((*len + l___10) + 1), 0);
  *str = (char *)tmp___16;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)", ", (size_t )l___10);
  *len += l___10;
  break;
  case 4: 
  l___11 = (int )(sizeof("Array, ") - 1U);
  tmp___17 = _erealloc((void *)*str, (size_t )((*len + l___11) + 1), 0);
  *str = (char *)tmp___17;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)"Array, ", (size_t )l___11);
  *len += l___11;
  break;
  case 5: 
  l___12 = (int )(sizeof("Object(") - 1U);
  tmp___18 = _erealloc((void *)*str, (size_t )((*len + l___12) + 1), 0);
  *str = (char *)tmp___18;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)"Object(", (size_t )l___12);
  *len += l___12;
  tmp___19 = zend_get_object_classname((zval const   *)*arg,
                                       (char const   **)(& class_name),
                                       & class_name_len);
  dup___0 = (int )tmp___19;
  l___13 = (int )class_name_len;
  tmp___20 = _erealloc((void *)*str, (size_t )((*len + l___13) + 1), 0);
  *str = (char *)tmp___20;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)class_name, (size_t )l___13);
  *len += l___13;
  if (! dup___0) {
  ...
  tmp___21 = _erealloc((void *)*str, (size_t )((*len + l___14) + 1), 0);
  *str = (char *)tmp___21;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)"), ", (size_t )l___14);
  *len += l___14;
  break;
  default: 
  break;
...
{ 
  ...
  num = tmp___2;
  tmp___3 = _emalloc((size_t )14);
  s_tmp = (char *)tmp___3;
  tmp___4 = *num;
  (*num) ++;
  sprintf((char */* __restrict  */)s_tmp,
          (char const   */* __restrict  */)"#%d ", tmp___4);
  tmp___5 = strlen((char const   *)s_tmp);
  l = (int )tmp___5;
  tmp___6 = _erealloc((void *)*str, (size_t )((*len + l) + 1), 0);
  *str = (char *)tmp___6;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)s_tmp, (size_t )l);
  *len += l;
  _efree((void *)s_tmp);
  tmp___12 = zend_hash_find((HashTable const   *)ht, "file", sizeof("file"),
                            (void **)(& file));
  if (tmp___12 == (int __attribute__((__visibility__("default")))  )0) {
    tmp___7 = zend_hash_find((HashTable const   *)ht, "line", sizeof("line"),
                             (void **)(& tmp));
    ...
    tmp___8 = _emalloc((size_t )((((*file)->value.str.len + 11) + 4) + 1));
    s_tmp = (char *)tmp___8;
    sprintf((char */* __restrict  */)s_tmp,
            (char const   */* __restrict  */)"%s(%ld): ",
            (*file)->value.str.val, line);
    tmp___9 = strlen((char const   *)s_tmp);
    l___0 = (int )tmp___9;
    tmp___10 = _erealloc((void *)*str, (size_t )((*len + l___0) + 1), 0);
    *str = (char *)tmp___10;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)s_tmp, (size_t )l___0);
    *len += l___0;
    _efree((void *)s_tmp);
  } else {
    l___1 = (int )(sizeof("[internal function]: ") - 1U);
    tmp___11 = _erealloc((void *)*str, (size_t )((*len + l___1) + 1), 0);
    *str = (char *)tmp___11;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)"[internal function]: ",
           (size_t )l___1);
    *len += l___1;
  }
  tmp___14 = zend_hash_find((HashTable const   *)ht, "class", sizeof("class"),
                            (void **)(& tmp));
  if (tmp___14 == (int __attribute__((__visibility__("default")))  )0) {
    l___2 = (*tmp)->value.str.len;
    tmp___13 = _erealloc((void *)*str, (size_t )((*len + l___2) + 1), 0);
    *str = (char *)tmp___13;
    memcpy((void */* __restrict  */)(*str + *len),
  ...
  tmp___16 = zend_hash_find((HashTable const   *)ht, "type", sizeof("type"),
                            (void **)(& tmp));
  if (tmp___16 == (int __attribute__((__visibility__("default")))  )0) {
    l___3 = (*tmp)->value.str.len;
    tmp___15 = _erealloc((void *)*str, (size_t )((*len + l___3) + 1), 0);
    *str = (char *)tmp___15;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)(*tmp)->value.str.val,
           (size_t )l___3);
  ...
  tmp___18 = zend_hash_find((HashTable const   *)ht, "function",
                            sizeof("function"), (void **)(& tmp));
  if (tmp___18 == (int __attribute__((__visibility__("default")))  )0) {
    l___4 = (*tmp)->value.str.len;
    tmp___17 = _erealloc((void *)*str, (size_t )((*len + l___4) + 1), 0);
    *str = (char *)tmp___17;
    memcpy((void */* __restrict  */)(*str + *len),
           (void const   */* __restrict  */)(*tmp)->value.str.val,
           (size_t )l___4);
  ...
  tmp___19 = _erealloc((void *)*str, (size_t )((*len + 1) + 1), 0);
  *str = (char *)tmp___19;
  tmp___20 = *len;
  (*len) ++;
  *(*str + tmp___20) = (char )'(';
  tmp___21 = zend_hash_find((HashTable const   *)ht, "args", sizeof("args"),
                            (void **)(& tmp));
  if (tmp___21 == (int __attribute__((__visibility__("default")))  )0) {
    last_len = *len;
    zend_hash_apply_with_arguments((*tmp)->value.ht,
                                   (int (*)(void *pDest , int num_args ,
                                            va_list args ,
                                            zend_hash_key *hash_key ))(& _build_trace_args),
                                   2, str, len);
    if (last_len != *len) {
      *len -= 2;
    } else {
  ...
  l___5 = (int )(sizeof(")\n") - 1U);
  tmp___22 = _erealloc((void *)*str, (size_t )((*len + l___5) + 1), 0);
  *str = (char *)tmp___22;
  memcpy((void */* __restrict  */)(*str + *len),
...
void zim_exception_getTraceAsString(int ht , zval *return_value ,
                                    zval **return_value_ptr , zval *this_ptr ,
                                    int return_value_used ) 
{ 
  zval *trace ;
  ...
  res = (char *)tmp___0;
  str = & res;
  tmp___1 = zend_read_property(default_exception_ce, this_ptr, (char *)"trace",
                               (int )(sizeof("trace") - 1U), (zend_bool )1);
  trace = (zval *)tmp___1;
  zend_hash_apply_with_arguments(trace->value.ht,
                                 (int (*)(void *pDest , int num_args ,
                                          va_list args ,
                                          zend_hash_key *hash_key ))(& _build_trace_string),
                                 3, str, len, & num);
  tmp___2 = _emalloc((size_t )20);
  s_tmp = (char *)tmp___2;
  sprintf((char */* __restrict  */)s_tmp,
          (char const   */* __restrict  */)"#%d {main}", num);
  tmp___3 = strlen((char const   *)s_tmp);
  l = (int )tmp___3;
  tmp___4 = _erealloc((void *)*str, (size_t )((*len + l) + 1), 0);
  *str = (char *)tmp___4;
  memcpy((void */* __restrict  */)(*str + *len),
         (void const   */* __restrict  */)s_tmp, (size_t )l);
  *len += l;
...
void zim_exception_getPrevious(int ht , zval *return_value ,
                               zval **return_value_ptr , zval *this_ptr ,
                               int return_value_used ) 
{ 
  zval *previous ;
  ...
  tmp___0 = zend_read_property(default_exception_ce, this_ptr,
                               (char *)"previous",
                               (int )(sizeof("previous") - 1U), (zend_bool )1);
...
{ 
  ...
  len = (*zend_vspprintf)(message, (size_t )max_len, (char const   *)format, arg);
  __builtin_va_end(arg);
  return (len);
}
}
void zim_exception___toString(int ht , zval *return_value ,
                              zval **return_value_ptr , zval *this_ptr ,
                              int return_value_used ) 
{ 
  zval message ;
  ...
  while (1) {
    ...
    prev_str = str;
    _default_exception_get_entry(exception, (char *)"message",
                                 (int )(sizeof("message") - 1U), & message);
    _default_exception_get_entry(exception, (char *)"file",
                                 (int )(sizeof("file") - 1U), & file);
    _default_exception_get_entry(exception, (char *)"line",
                                 (int )(sizeof("line") - 1U), & line);
    ...
    if (message.value.str.len > 0) {
      ...
      len = zend_spprintf(& str, 0,
                          (char *)"exception \'%s\' with message \'%s\' in %s:%ld\nStack trace:\n%s%s%s",
                          tmp___5->name, message.value.str.val,
                          file.value.str.val, line.value.lval, tmp___4, tmp___3,
                          prev_str);
    } else {
      if (len) {
        tmp___6 = "\n\nNext ";
      ...
      len = zend_spprintf(& str, 0,
                          (char *)"exception \'%s\' in %s:%ld\nStack trace:\n%s%s%s",
                          tmp___8->name, file.value.str.val, line.value.lval,
                          tmp___7, tmp___6, prev_str);
    }
    _efree((void *)prev_str);
    _zval_dtor(& message);
    _zval_dtor(& file);
    _zval_dtor(& line);
    tmp___9 = zend_read_property(default_exception_ce, exception,
                                 (char *)"previous",
                                 (int )(sizeof("previous") - 1U), (zend_bool )0);
  ...
  _zval_dtor(& fname);
  zend_update_property_string(default_exception_ce, this_ptr, (char *)"string",
                              (int )(sizeof("string") - 1U), (char const   *)str);
  while (1) {
...
static zend_arg_info const   arginfo_exception___construct[4]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      ...
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"previous", sizeof("previous") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_function_entry const   default_exception_functions[11]  = 
  {      {"__clone", & zim_exception___clone,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )1028}, 
        {"__construct", & zim_exception___construct, arginfo_exception___construct,
      sizeof(arginfo_exception___construct) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )256}, 
        {"getMessage", & zim_exception_getMessage,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {"getCode", & zim_exception_getCode,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {"getFile", & zim_exception_getFile,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {"getLine", & zim_exception_getLine,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {"getTrace", & zim_exception_getTrace,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {"getPrevious", & zim_exception_getPrevious,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {"getTraceAsString", & zim_exception_getTraceAsString,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {"__toString", & zim_exception___toString,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )0}, 
        {(char const   *)((void *)0),
      (void (*)(int ht , zval *return_value ,
                zval **return_value_ptr , zval *this_ptr ,
                int return_value_used ))((void *)0),
      (struct _zend_arg_info  const  *)((void *)0), 0U, 0U}};
static zend_arg_info const   arginfo_error_exception___construct[7]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"message", sizeof("message") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"code", sizeof("code") - 1U, (char const   *)((void *)0), (zend_uint )0,
      (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"severity", sizeof("severity") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"filename", sizeof("filename") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"lineno", sizeof("lineno") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
        {"previous", sizeof("previous") - 1U, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_function_entry const   error_exception_functions[3]  = {      {"__construct", & zim_error_exception___construct,
      arginfo_error_exception___construct,
      sizeof(arginfo_error_exception___construct) / sizeof(struct _zend_arg_info ) - 1U,
      (zend_uint )256}, 
        {"getSeverity", & zim_error_exception_getSeverity,
      (struct _zend_arg_info  const  *)((void *)0),
      sizeof((void *)0) / sizeof(struct _zend_arg_info ) - 1U, (zend_uint )260}, 
        {(char const   *)((void *)0),
      (void (*)(int ht , zval *return_value ,
...
{ 
  ...
  memcpy((void */* __restrict  */)(& default_exception_handlers),
         (void const   */* __restrict  */)tmp___2, sizeof(zend_object_handlers ));
  default_exception_handlers.clone_obj = (zend_object_value (*)(zval *object ))((void *)0);
  zend_declare_property_string(default_exception_ce, (char *)"message",
                               (int )(sizeof("message") - 1U), "", 512);
  zend_declare_property_string(default_exception_ce, (char *)"string",
                               (int )(sizeof("string") - 1U), "", 1024);
  zend_declare_property_long(default_exception_ce, (char *)"code",
                             (int )(sizeof("code") - 1U), 0L, 512);
  zend_declare_property_null(default_exception_ce, (char *)"file",
                             (int )(sizeof("file") - 1U), 512);
  zend_declare_property_null(default_exception_ce, (char *)"line",
                             (int )(sizeof("line") - 1U), 512);
  zend_declare_property_null(default_exception_ce, (char *)"trace",
                             (int )(sizeof("trace") - 1U), 1024);
  zend_declare_property_null(default_exception_ce, (char *)"previous",
                             (int )(sizeof("previous") - 1U), 1024);
  ...
  tmp___5 = zend_register_internal_class_ex(& ce, default_exception_ce,
                                            (char *)((void *)0));
  error_exception_ce = (zend_class_entry *)tmp___5;
  error_exception_ce->create_object = & zend_error_exception_new;
  zend_declare_property_long(error_exception_ce, (char *)"severity",
                             (int )(sizeof("severity") - 1U), 1L, 512);
  return;
}
}
zend_class_entry __attribute__((__visibility__("default")))  *zend_exception_get_default(void) 
...
{ 
  ...
  ex->refcount__gc = (zend_uint )1;
  ex->is_ref__gc = (zend_uchar )0;
  if (exception_ce) {
    tmp___0 = instanceof_function((zend_class_entry const   *)exception_ce,
                                  (zend_class_entry const   *)default_exception_ce);
    if (tmp___0) {
  ...
  if (message) {
    zend_update_property_string(default_exception_ce, ex, (char *)"message",
                                (int )(sizeof("message") - 1U),
                                (char const   *)message);
  } else {
  ...
  if (code) {
    zend_update_property_long(default_exception_ce, ex, (char *)"code",
                              (int )(sizeof("code") - 1U), code);
  } else {
...
{ 
  ...
  {
  __builtin_va_start(arg, format);
  (*zend_vspprintf)(& message, (size_t )0, (char const   *)format, arg);
  __builtin_va_end(arg);
...
{ 
  ...
  tmp = zend_throw_exception(exception_ce, message, code);
  ex = (zval *)tmp;
  zend_update_property_long(default_exception_ce, ex, (char *)"severity",
                            (int )(sizeof("severity") - 1U), (long )severity);
  return ((zval __attribute__((__visibility__("default")))  *)ex);
}
}
static void zend_error_va(int type , char const   *file , uint lineno ,
                          char const   *format  , ...) 
{ 
  va_list args ;
  ...
  (*zend_error_cb)(type, file, (uint const   )lineno, format, args);
...
{ 
  ...
  tmp___10 = instanceof_function((zend_class_entry const   *)ce_exception,
                                 (zend_class_entry const   *)default_exception_ce);
  if (tmp___10) {
    executor_globals.exception = (zval *)((void *)0);
    zend_call_method(& exception, ce_exception, (zend_function **)((void *)0),
                     (char *)"__tostring", (int )(sizeof("__tostring") - 1U),
                     & str, 0, (zval *)((void *)0), (zval *)((void *)0));
    if (! executor_globals.exception) {
      if ((int )str->type != 6) {
        zend_error(1 << 1L, "%s::__toString() must return a string",
                   ce_exception->name);
      } else {
        if (executor_globals.exception) {
        ...
        zend_update_property_string(default_exception_ce, exception,
                                    (char *)"string",
                                    (int )(sizeof("string") - 1U), tmp___0);
      }
    } else {
    ...
    _zval_ptr_dtor(& str);
    if (executor_globals.exception) {
      tmp___3 = instanceof_function((zend_class_entry const   *)ce_exception,
                                    (zend_class_entry const   *)default_exception_ce);
      if (tmp___3) {
        tmp___1 = zend_read_property(default_exception_ce,
                                     executor_globals.exception, (char *)"file",
                                     (int )(sizeof("file") - 1U), (zend_bool )1);
        file = (zval *)tmp___1;
        tmp___2 = zend_read_property(default_exception_ce,
                                     executor_globals.exception, (char *)"line",
                                     (int )(sizeof("line") - 1U), (zend_bool )1);
        line = (zval *)tmp___2;
      } else {
        file = (zval *)((void *)0);
        line = (zval *)((void *)0);
      ...
      zend_error_va(1 << 1L, (char const   *)tmp___6, (uint )tmp___5,
                    "Uncaught %s in exception handling during call to %s::__tostring()",
                    tmp___4->name, ce_exception->name);
    } else {

    }
    tmp___7 = zend_read_property(default_exception_ce, exception,
                                 (char *)"string",
                                 (int )(sizeof("string") - 1U), (zend_bool )1);
    str = (zval *)tmp___7;
    tmp___8 = zend_read_property(default_exception_ce, exception,
                                 (char *)"file", (int )(sizeof("file") - 1U),
                                 (zend_bool )1);
    file = (zval *)tmp___8;
    tmp___9 = zend_read_property(default_exception_ce, exception,
                                 (char *)"line", (int )(sizeof("line") - 1U),
                                 (zend_bool )1);
    line = (zval *)tmp___9;
    zend_error_va(severity, (char const   *)file->value.str.val,
                  (uint )line->value.lval, "Uncaught %s\n  thrown",
                  str->value.str.val);
  } else {
