...
static zend_arg_info const   arginfo_get_defined_constants[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      ...
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}};
static zend_arg_info const   arginfo_debug_backtrace[2]  = {      {(char const   *)((void *)0), (zend_uint )0, (char const   *)((void *)0),
      (zend_uint )0, (zend_uchar )0, (zend_bool )0, (zend_bool )0}, 
...
{ 
  ...
  tmp___1 = zend_get_object_classname((zval const   *)obj,
                                      (char const   **)(& name), & name_len);
  dup = (int )tmp___1;
  while (1) {
...
{ 
  ...
  tmp___4 = zend_lookup_class_ex((char const   *)class_name, class_name_len,
  ...
  if (tmp___4 == (int __attribute__((__visibility__("default")))  )-1) {
    ...
    tmp___3 = instanceof_function((zend_class_entry const   *)instance_ce,
                                  (zend_class_entry const   *)*ce);
    if (tmp___3) {
      retval = (zend_bool )1;
    } else {
...
{ 
  ...
  while (1) {
    ...
    if (tmp___3 == (int __attribute__((__visibility__("default")))  )1) {
      ...
      if (tmp___2 == (int __attribute__((__visibility__("default")))  )0) {
        zend_unmangle_property_name(key, (int )(key_len - 1U), & class_name,
                                    & prop_name);
        zval_addref_p(*value);
        tmp___1 = strlen((char const   *)prop_name);
        add_assoc_zval_ex(return_value, (char const   *)prop_name, tmp___1 + 1U,
                          *value);
      } else {
...
{ 
  ...
  if ((int )func->type == 1) {
    add_next_index_stringl(internal_ar, (char const   *)hash_key->arKey,
                           hash_key->nKeyLength - 1U, 1);
  } else
  if ((int )func->type == 2) {
    add_next_index_stringl(user_ar, (char const   *)hash_key->arKey,
                           hash_key->nKeyLength - 1U, 1);
  } else {
  ...
  if (retval == 0) {
    ...
    *(function_name + 0) = (char )'\000';
    while (1) {
      ...
      tmp___8 = sprintf((char */* __restrict  */)(function_name + 1),
