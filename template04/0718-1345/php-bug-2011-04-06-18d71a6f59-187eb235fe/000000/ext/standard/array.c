...
extern void __attribute__((__visibility__("default")))  php_spl_object_hash(zval *obj ,
                                                                            char *md5str ) ;
extern zend_function *php_spl_get_constructor_helper(zval *object ,
                                                     int (*validating_fun)(void *object_data ) ) ;
  ...
  if ((array->value.obj.handlers)->get_class_entry) {
    ...
    if (tmp___6) {
      zend_call_method(& array, (zend_class_entry *)((void *)0),
                       (zend_function **)((void *)0), (char *)"count",
...
{ 
  ...
  *key2 = (zval )zval_used_for_init;
  ...
  if (f->nKeyLength == 0U) {
    ...
    tmp___1 = _estrndup((char const   *)f->arKey, f->nKeyLength - 1U);
  ...
  if (s->nKeyLength == 0U) {
    ...
    tmp___2 = _estrndup((char const   *)s->arKey, s->nKeyLength - 1U);
...
{ 
  ...
  while (1) {
    ...
    if (p->nKeyLength == 0U) {
      ...
      _zend_hash_quick_add_or_update(out_hash, (char const   *)p->arKey,
                                     p->nKeyLength, p->h, (void *)(& entry),
                                     sizeof(zval *), (void **)((void *)0), 1);
    }
    pos ++;
    p = p->pListNext;
  ...
  if ((unsigned int )removed != (unsigned int )((void *)0)) {
    while (1) {
      ...
      if (p->nKeyLength == 0U) {
        ...
        _zend_hash_quick_add_or_update(*removed, (char const   *)p->arKey,
                                       p->nKeyLength, p->h, (void *)(& entry),
                                       sizeof(zval *), (void **)((void *)0), 1);
      }
      pos ++;
...
{ 
  ...
  if (key) {
    if ((unsigned int )stack->value.ht == (unsigned int )(& executor_globals.symbol_table)) {
      zend_delete_global_variable(key, (int )(key_len - 1U));
    } else {
      goto _L;
    }
  } else {
